...
def ISE_posture_count(url, username, password):
    try:   
        ...
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = posture_count_template.render(postureCount = postureCount,filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
...
def ISE_profiler_count(url, username, password):
    try:   
        ...
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = profiler_count_template.render(profilerCount = profilerCount,filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
