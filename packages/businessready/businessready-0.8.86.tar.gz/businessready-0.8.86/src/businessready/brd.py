...
def ISE_deployment_node(url, username, password):
    try:
        ...
        # Render Templates
            for filetype in filetype_loop:
                parsed_output = deployment_node_template.render(nodes = deploymentNodeAllJSON,filetype_loop=loop_counter)
                loop_counter = loop_counter + 1
    ...
    # -------------------------
                ...
                with open(f"ISE Deployment Node.json", "w") as fh:
                    ...
                    fh.close()                            
        return(deploymentNodeAllJSON['deploymentNodeAllJSON'])
    except Exception as e:
        logging.exception(e)
