...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// PARTY/FRIENDS/ADMIN //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    @commands.party_only()
    @commands.command(name='SalutSalut',aliases=['inviteowner','参加','さんおばよろしく_2: 参加ありがとう','fnpy','doener','Item','Notice','ク','ア','や','招','待','式','ボ','公','テ','【ギフト】と入力','fnpy','doener','Item','Notice','ク','ア','や','招','待','式','ボ','公','テ','je suis gay','created bot by g3_piton-52','Item','Notice:','This','If', 'Sup','見','ギ','Made','MATHYLOLFN','Could not find','Please note that', 'inviteowner','crea to','Para utlizar','Please note that if you invite a large number of bots','POR EL TIKTOKER','en el canal','Twitter','tutorial','como','TIKTOKER','link:','el','entra','linkfly.to/withgex','your','@gextrap','MATHYLOLFN','XBX','cloudy','USE CODE XBX','discord.gg/tKZknTDaqh'], hidden=True)
