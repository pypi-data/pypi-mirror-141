...
setup(
  name = 'temppython',         # How you named your package folder (MyLib)
  packages = ['temppython'],   # Chose the same as "name"
  ...
  author_email = 'vivek.lakhataria@alpsinfo.net',      # Type in your E-Mail
