...
#         cv2.waitKey(0)
        return final, NEGATIVE                                                       ## Return 4: Normal return

    def calculation(self, image):
        blc,_ =self.target_cut(self, image)
        return [NEGATIVE, blc]
...
##            opening = cv2.morphologyEx(opening, cv2.MORPH_CLOSE, kernel)
            ...
            block = self.block_cut(final, x, y)        
