...
class IELTS(Language):
    ...
    writting=models.DecimalField(max_digits=2,decimal_places=1)
    listening=models.DecimalField(max_digits=2,decimal_places=1)
    speaking=models.DecimalField(max_digits=2,decimal_places=1)
    type_of_test=models.CharField(max_length=15,choices=TYPE,default='General')
    report_number=models.CharField(max_length=20,blank=True)
...
class CELPIP(Language):
    ...
    pin_number=models.CharField(max_length=8,blank=True)
