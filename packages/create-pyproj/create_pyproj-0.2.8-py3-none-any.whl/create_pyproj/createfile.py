...
def copyTemplates(projectname: str, cli: bool, no_init: bool, no_install: bool, python_version: str):
    """
    [summary]
...
def createFiles(projectname: str, cli: bool, no_init: bool, no_install: bool, python_version: str):
    PROJECT_ROOT = Path.cwd() / projectname
    data = {
