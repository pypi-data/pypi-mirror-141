...
def create_pyproj(args: argparse.Namespace):
    ...
    data = vars(args)
    try:
        copyTemplates(args.projectname, args.cli, args.no_init, args.no_install, args.python_version)
        createFiles(args.projectname, args.cli, args.no_init, args.no_install, args.python_version)
