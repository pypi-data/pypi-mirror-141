...
from test.test_utils import make_test_atlas, standardise_sql_string, assert_locked_lockable, check_class_docstrings_in_module
...
class TestRowSetOpExpressions(unittest.TestCase):
    ...
    def test_combination_of_row_set_ops(self):
        ...
        expected = """
               SELECT
                 [AppDomainId], [Application], [AppVersion], [AwsInstanceId]
               FROM
