...
def api_doc(request, renderer_values):
    ...
    with open(view.find_resource_path(f'static/css/api-doc-bs{bootstrap_version}.css'), 'r', encoding='utf-8') as fp:
        renderer_values['css'] = fp.read()

    with open(view.find_resource_path('static/js/api-doc.js'), 'r', encoding='utf-8') as fp:
