...
<div class="module collapse show" id="${module_id}" aria-multiselectable="true">
    ...
    <div class="card service">
        <div class="card-header p-0 border-bottom-0">
            <h5 class="card-title service-title" data-toggle="collapse" data-target="#collapse-${service_id}" aria-expanded="true" aria-controls="collapse-${service_id}">
                ## Methods
        ...
        <div id="collapse-${service_id}" class="service-collapse collapse" data-parent="#${module_id}" aria-labelledby="heading-${service_id}">
