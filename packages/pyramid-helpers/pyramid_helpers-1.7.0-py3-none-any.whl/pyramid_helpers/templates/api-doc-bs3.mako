...
<div class="panel-group module collapse in" id="${module_id}" role="tablist" aria-multiselectable="true">
        % for service in module['services']:
            <% service_id = service['name'].replace('.', '-') %>
            % if not service['allowed'] or (service['doc'] is None and hide_undocumented):
                <% continue %>
            % endif
    <div class="panel service panel-default">
        <div class="panel-heading" role="tab" id="heading-${service_id}">
            <h5 class="panel-title service-title" data-toggle="collapse" data-target="#collapse-${service_id}" aria-expanded="true" aria-controls="collapse-${service_id}">
                ## Methods
        ...
        <div id="collapse-${service_id}" class="service-collapse collapse out" data-parent="#${module_id}" role="tabpanel" aria-labelledby="heading-${service_id}">
