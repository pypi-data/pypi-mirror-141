...
<div class="row">
  <div class="col-md-12 d-flex flex-row justify-content-between mb-3">
    ...
    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#help-modal">
...
<h5 class="module-title" data-bs-toggle="collapse" data-bs-target="#${module_id}" aria-controls="${module_id}">
  ${module['doc'].split('\n')[0] if module['doc'] is not None else translate('??? Undocumented module ???')}
  <i class="fa fa-chevron-up fa-sm float-end"></i>
</h5>

<div class="module collapse show" id="${module_id}" aria-multiselectable="true">
  ...
  <div class="card service">
    <div class="card-header p-0 border-bottom-0">
      <h5 class="card-title service-title" data-bs-toggle="collapse" href="#collapse-${service_id}" aria-expanded="true" aria-controls="collapse-${service_id}">
        ## Methods
        ...
        <span class="service-description p-2 ms-auto service-description-${method}">
            ${service['doc'].split('\n')[0]}
        </span>
            % endif
      </h5>
    ...
    <div id="collapse-${service_id}" class="service-collapse collapse" data-bs-parent="#${module_id}" aria-labelledby="heading-${service_id}">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item active"><a href="#request-methods" class="nav-link active" aria-controls="request-methods" aria-selected="false" role="tab" data-bs-toggle="tab">Request Methods</a></li>
          <li class="nav-item"><a href="#response-codes" class="nav-link" aria-controls="response-codes" aria-selected="false" aria-selected="false" role="tab" data-bs-toggle="tab">Response Status Codes</a></li>
          <li class="nav-item"><a href="#examples" class="nav-link" aria-controls="examples" aria-selected="false" role="tab" data-bs-toggle="tab">Examples</a></li>
          <li class="nav-item"><a href="#faq" class="nav-link" aria-controls="faq" aria-selected="false" role="tab" data-bs-toggle="tab">FAQ</a></li>
        </ul>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card" id="response-request-url">
          <div class="card-header p-2 fw-bold">${translate('Request URL')}</div>
          <div class="card-body p-2">
            <pre class="mb-0 p-0"></pre>
          </div>
        </div>

        <div class="card" id="response-request-data">
          <div class="card-header p-2 fw-bold">${translate('Request Data')}</div>
          <div class="card-body p-2">
            <pre class="mb-0 p-0"></pre>
          </div>
        </div>
        ...
        <div class="card" id="response-request-curl-cmd">
          <div class="card-header p-2 fw-bold">${translate('CURL Command')}</div>
          <div class="card-body p-2">
            <pre class="mb-0 p-0"></pre>
          </div>
        </div>

        <div class="card" id="response-code">
          <div class="card-header p-2 fw-bold">${translate('Response Status Code')}</div>
          <div class="card-body p-2">
            <pre class="mb-0 p-0"></pre>
          </div>
        </div>
        ...
        <div class="card" id="response-body">
          <div class="card-header p-2 fw-bold">${translate('Response Body')}</div>
          <div class="card-body p-2">
            <pre class="mb-0 p-0"></pre>
          </div>
        </div>

        <div class="card mb-0" id="response-headers">
          <div class="card-header p-2 fw-bold">${translate('Response Headers')}</div>
          <div class="card-body p-2">
            <pre class="mb-0 p-0"></pre>
          </div>
        </div>
