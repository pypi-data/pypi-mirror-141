import{a as t,r as o,_ as e,c as s,f as i,n as r,s as n,$ as a}from"./index-92d154f2.js";import"./c.722f5049.js";import"./c.1cb51b24.js";import{g as c}from"./c.cb8aec9e.js";import{m as l,s as p,a as m}from"./c.ee1971f8.js";const h=(t,o)=>{import("./c.3fd372ce.js");const e=document.createElement("esphome-logs-dialog");e.configuration=t,e.target=o,document.body.append(e)},d=(t,o,e)=>{import("./c.9932eb4a.js");const s=document.createElement("esphome-logs-webserial-dialog");s.configuration=e,s.port=t,s.closePortOnClose=o,document.body.append(s)};let w=class extends n{constructor(){super(...arguments),this._show="options"}render(){let t,o;return"options"===this._show?(t="How to get the logs for your device?",o=a`
        <mwc-list-item
          twoline
          hasMeta
          dialogAction="close"
