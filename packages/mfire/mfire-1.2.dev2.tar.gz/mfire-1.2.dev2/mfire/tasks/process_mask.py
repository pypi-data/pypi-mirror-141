...
from mfire.utils import JsonFile, MD5, handle_error
...
if __name__ == "__main__":
    ...
    if args.nproc > 1:
        ...
        for conf in dict_config.keys():
            pool.apply_async(
                main, args=(dict_config[conf],), error_callback=module_error_handler,
            )
        pool.close()
        pool.join()
    else:
