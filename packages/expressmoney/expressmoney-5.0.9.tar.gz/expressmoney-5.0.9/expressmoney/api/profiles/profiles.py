...
class RussianProfileReadContractMixin:
    # Russian fields
...
class RussianProfileUpdateContract(RussianProfileUpdateContractMixin, ProfileUpdateContract):
    pass


class RussianProfileCreateContract(RussianProfileUpdateContractMixin,
                                   RussianProfileCreateContractMixin,
                                   ProfileCreateContract
                                   ):
    pass


class RussianProfileReadContract(RussianProfileUpdateContractMixin,
                                 RussianProfileCreateContractMixin,
                                 RussianProfileReadContractMixin,
                                 ProfileReadContract,
                                 ):
    pass
