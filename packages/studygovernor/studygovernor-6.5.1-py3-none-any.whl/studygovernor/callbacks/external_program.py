...
def external_program(experiment: Experiment,
                     action: Action,
                     config: Dict[str, Any],
                     binary: str,
    ...
    xnat_uri = experiment.session.external_systems['XNAT'].url.rstrip('/')
    ...
    kwargs = {k: v.replace("$EXPERIMENT", experiment.external_uri()) for k, v in kwargs.items()}
    ...
    return "=======\nSTDERR:\n=======\n{}\n\n=======\nSTDOUT\n=======\n{}".format(stderr.decode(), stdout.decode())
