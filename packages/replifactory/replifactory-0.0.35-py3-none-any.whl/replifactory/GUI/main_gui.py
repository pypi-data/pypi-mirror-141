...
class MainGuiBuilder:
    def __init__(self):
        ...
        self.device_config_tab.widget.layout = Layout(height=height, width=width, flex_flow="wrap row", display="flex", align_content="flex-start")
        ...
        self.photo_tab.widget.layout = Layout(height=height, width=width, flex_flow="wrap", display="flex", align_content="flex-start")
        self.update()
