...
class AnsibleGitRemote(object):
    ...
    def __init__(self, ca_cert=None, rate_limit=None, pulp_labels=None, proxy_url=None, sock_read_timeout=None, proxy_username=None, password=None, download_concurrency=None, client_key=None, connect_timeout=None, client_cert=None, username=None, sock_connect_timeout=None, headers=None, url=None, max_retries=None, proxy_password=None, name=None, tls_validation=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
