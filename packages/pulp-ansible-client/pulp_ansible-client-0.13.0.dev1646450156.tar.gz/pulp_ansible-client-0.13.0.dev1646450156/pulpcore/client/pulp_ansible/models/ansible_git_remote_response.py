...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, ca_cert=None, rate_limit=None, pulp_created=None, pulp_labels=None, proxy_url=None, sock_read_timeout=None, download_concurrency=None, pulp_href=None, connect_timeout=None, client_cert=None, sock_connect_timeout=None, headers=None, url=None, max_retries=None, pulp_last_updated=None, name=None, tls_validation=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
