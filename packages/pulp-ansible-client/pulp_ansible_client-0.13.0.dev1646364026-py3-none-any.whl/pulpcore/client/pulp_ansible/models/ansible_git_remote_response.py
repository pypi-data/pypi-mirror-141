...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_connect_timeout=None, max_retries=None, client_cert=None, headers=None, tls_validation=None, sock_read_timeout=None, name=None, url=None, proxy_url=None, pulp_last_updated=None, total_timeout=None, ca_cert=None, rate_limit=None, connect_timeout=None, pulp_labels=None, pulp_href=None, download_concurrency=None, pulp_created=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
