...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, sock_connect_timeout=None, max_retries=None, password=None, client_cert=None, username=None, headers=None, proxy_password=None, tls_validation=None, sock_read_timeout=None, name=None, url=None, client_key=None, proxy_url=None, proxy_username=None, total_timeout=None, ca_cert=None, rate_limit=None, connect_timeout=None, pulp_labels=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
