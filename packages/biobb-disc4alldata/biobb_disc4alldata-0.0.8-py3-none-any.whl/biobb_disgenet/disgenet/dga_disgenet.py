...
class DGA_disgenet(BiobbObject):
    """
    ...
    def launch(self) -> int:
        ...
        #Try1 function
        response = auth("gda", self.io_dict["in"]["retrieve_by"], self.properties, self.out_log, self.global_log)
...
def dga_disgenet(retrieve_by: str , output_file_path: str, properties: dict = None, **kwargs) -> int:
