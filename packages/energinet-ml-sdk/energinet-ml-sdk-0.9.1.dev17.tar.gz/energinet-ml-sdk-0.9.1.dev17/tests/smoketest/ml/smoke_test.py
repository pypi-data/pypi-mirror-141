...
from energinetml.core.model import LoadedModel, ModelArtifact
...
def test__energinetml__model_train(
    ...
    outputs_path = os.path.join(model_folder_path, DEFAULT_RELATIVE_ARTIFACT_PATH)

    ma = ModelArtifact(outputs_path, "fiktiv", {})
    loaded_model = LoadedModel.from_artifact(ma)
    loaded_model.trained_model.verify()
