...
class FuConfigParser(configparser.RawConfigParser):
    ...
    def getlist(self,  section: str, option: str, separators: str=',', strip:bool=True, lower:bool=False, **kwargs) -> list:
    ...
    def get(self, section: str, option: str, *args, **kwargs) -> str:
        ...
        resolve_env = kwargs.pop("resolve_env", False)
        outstring = super().get(section, option, *args, **kwargs)
        if resolve_env:
...
class Suspect(SimpleTimeoutMixin):
    ...
    def _parse_rcvd_header(self, rcvdline):
        ...
        receivedbypattern = re.compile(r"\s+(by\s+(?P<by>[^\s]+))")
...
------=_MIME_BOUNDARY_000_12140--"""
    ...
    eicar_body = """Date: Mon, 08 Sep 2008 17:33:54 +0200
To: oli@unittests.fuglu.org
From: oli@unittests.fuglu.org
...
"""
    ...
    def lint_eicar(self, scan_function_name='scan_stream'):
        ...
        try:
            bodyeicar = self.config.getboolean(self.section, 'lint_body_eicar')
        except Exception:
            bodyeicar = False
