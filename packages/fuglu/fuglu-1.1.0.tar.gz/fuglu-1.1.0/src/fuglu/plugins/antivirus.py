...
"""
    ...
    def scan_stream(self, content, suspectid='(NA)'):
        ...
        if send_fakeheaders:
            fakerequestheader = "GET http://localhost/message.eml HTTP/1.1%s" + CRLF
