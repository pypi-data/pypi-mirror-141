...
class MainController(DefConfigMixin):
    ...
    def __init__(self, config, logQueue=None, logProcessFacQueue=None, nolog=False):
        ...
        self.requiredvars = {
            ...
            'dbpriority': {
                ...
                'description': """read runtime configuration values from database types specified in this order. currently supported db types: sql, rest""",
            },
            ...
            'restapi_headers': {
                'default': "",
                'section': 'databaseconfig',
                'description': """list of additional headers, e.g. for API authentication""",
                'confidential': True,
            },
    ...
    def _load_all(self, plugins):
        ...
        pluglist = []
        config_re = re.compile(r"^(?P<structured_name>[a-zA-Z0-9._-]+)(?:\((?P<config_override>[a-zA-Z0-9._-]+)\))?$")
        allOK = True
        for plug in plugins:
            if plug == "":
                continue
