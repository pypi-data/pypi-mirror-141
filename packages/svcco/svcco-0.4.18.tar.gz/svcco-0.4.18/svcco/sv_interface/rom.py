rom="""if not terminating:
    ...
    for face_name in outlets:
        bcs.add_resistance(face_name=str(face_name),resistance=((1/resistance[face_name])/total_res)*outlet_res_total)
    ...
    if {} == 1:
        ...
        if platform.system() == 'Windows':
            ...
            if len(files) > 0:
                ...
                shutil.copy(files[0],oneD_folder)
            else:
