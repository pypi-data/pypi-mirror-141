...
setup(
    ...
    package_dir={'': 'src'},
    long_description="""<img width='90%' alt='Kiqpo-python web ui framework applications' src='https://www.linkpicture.com/q/kiqpo_1.svg'/>
<br/>
<br/>
...
""",
    ...
    keywords=['Kiqpo', 'ui', 'ux', 'web'],
    scripts=['src/kiqpo', 'src/web.py', 'src/const.py', 'src/color.py',
             'src/config.py', 'src/files.py'],
    classifiers=[
