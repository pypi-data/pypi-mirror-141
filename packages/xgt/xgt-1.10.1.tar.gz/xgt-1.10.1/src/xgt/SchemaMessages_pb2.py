...
_QUERYEDGELIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='plan_score', full_name='xgt.QueryEdgeList.plan_score', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_plan_score', full_name='xgt.QueryEdgeList._plan_score',
...
_QUERYEDGELIST.oneofs_by_name['_plan_score'].fields.append(
  _QUERYEDGELIST.fields_by_name['plan_score'])
_QUERYEDGELIST.fields_by_name['plan_score'].containing_oneof = _QUERYEDGELIST.oneofs_by_name['_plan_score']
