...
class EAM:
	...
	* Methods:
	...
	def __init__(self, element, force_field, model_type='BULK', zDirect='001', thickness=20):
		""" element         : 'Al', 'Cu',...
			force_field  : 
		...
		else: raise Exception("No Data is found for the element")
...
class ReaxFF:
	...
	* Methods:
	...
	def __init__(self, element, force_field, model_type='BULK', zDirect='001'):
		""" element         : 'V2O5',...
			force_field  : 
				'V2O5' : 'Chenoweth2008';...
			model_type       : 'BULK' or 'PLATE'
