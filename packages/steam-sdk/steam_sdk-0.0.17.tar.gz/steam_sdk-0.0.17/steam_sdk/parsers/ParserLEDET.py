...
from steam_sdk.parsers.ParserExcel import read_row, compare_two_parameters
...
class ParserLEDET:
    ...
    def writeLedet2Excel(self, nameFileLEDET: str, verbose: bool = True, SkipConsistencyCheck: bool = False):
        '''
