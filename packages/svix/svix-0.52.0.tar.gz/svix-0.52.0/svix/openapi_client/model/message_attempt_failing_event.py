...
def lazy_import():
    ...
    globals()['MessageAttemptFailingEventData'] = MessageAttemptFailingEventData


class MessageAttemptFailingEvent(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (MessageAttemptFailingEventData,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): [optional] if omitted the server will use the default value of "message.attempt.failing"  # noqa: E501
        """
