...
class MessageEndpointOut(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'filter_types': ([str], none_type),  # noqa: E501
            'next_attempt': (datetime, none_type),  # noqa: E501
            'rate_limit': (int, none_type),  # noqa: E501
    ...
    def _from_openapi_data(cls, created_at, id, status, url, version, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            channels ([str]): List of message channels this endpoint listens to (omit for all). [optional]  # noqa: E501
