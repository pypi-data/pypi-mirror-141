...
from tools import get_engine, get_session
...
class ExpertBase(Base):
    ...
    # attributes
    many_r = Column(String(255))  # 红球
    save_r = Column(String(255))  # 红胆
    many_b = Column(String(255))  # 篮球
    save_b = Column(String(255))  # 蓝胆

    # verify attributes
    v_many_r = Column(String(255))
    v_save_r = Column(String(255))
    v_many_b = Column(String(255))
    v_save_b = Column(String(255))
...
class PredictSSQ(Base):
    ...
    issue_name = Column(String(255), primary_key=True)
    ...
    red25 = Column(String(255), nullable=True)
    red20 = Column(String(255), nullable=True)
    red12 = Column(String(255), nullable=True)
    red10 = Column(String(255), nullable=True)
    red_save1 = Column(String(255), nullable=True)
    red_save2 = Column(String(255), nullable=True)
    red_save3 = Column(String(255), nullable=True)
    red_kill3 = Column(String(255), nullable=True)
    red_kill6 = Column(String(255), nullable=True)
    red_begin2 = Column(String(255), nullable=True)
    red_end2 = Column(String(255), nullable=True)
    blue_kill5 = Column(String(255), nullable=True)
    blue_save2 = Column(String(255), nullable=True)
    blue_save3 = Column(String(255), nullable=True)
    blue_save4 = Column(String(255), nullable=True)
    blue_save5 = Column(String(255), nullable=True)
