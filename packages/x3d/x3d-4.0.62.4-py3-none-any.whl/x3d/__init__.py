...
try:
    from x3d.x3d import *
    print('*** successful invocation: from x3d.x3d import *', flush=True)
except:
#   print('*** invocation failure: from x3d.x3d import *', flush=True)
    try:
        from .x3d import *
        print('*** successful invocation: from .x3d import *', flush=True)
    except:
    #   print('*** invocation failure: from .x3d import *', flush=True)
        try:
            from x3d import *
            print('*** successful invocation: from x3d import *', flush=True)
        except:
        #   print('*** invocation failure: from x3d import *', flush=True)
            try:
                from src.x3d import *
                print('*** successful invocation: from src.x3d import *', flush=True)
            except:
            #   print('*** invocation failure: from src.x3d import *', flush=True)
                try:
                    from src.x3d.x3d import *
                    print('*** successful invocation: from src.x3d.x3d import *', flush=True)
                except:
                #   print('*** invocation failure: from src.x3d.x3d import *', flush=True)
                    print('*** invocation failure: unable to perform variations of "from x3d import *"', flush=True)
