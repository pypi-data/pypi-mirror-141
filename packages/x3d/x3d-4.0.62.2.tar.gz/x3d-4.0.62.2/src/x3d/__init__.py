...
print('====================================')
print('PyPi package __init__.py diagnostics')
try:
    from .x3d import *
    print('success, from .x3d import *')
except:
    print('failure, from .x3d import *')
try:
    from x3d import *
    print('success, from x3d import *')
except:
...
try:
    from x3d.x3d import *
    print('success, from x3d.x3d import *')
except:
    print('failure, from x3d.x3d import *')
try:
    from src.x3d import *
    print('success, from src.x3d import *')
except:
    print('failure, from src.x3d import *')
try:
    from src.x3d.x3d import *
    print('success, from src.x3d.x3d import *')
except:
    print('failure, from src.x3d.x3d import *')

if not has_imported("x3d"):
    print('Error, x3d module not imported by __init__.py')
print('====================================')
