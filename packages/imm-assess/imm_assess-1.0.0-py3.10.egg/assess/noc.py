...
def main():
    ...
    parser.add_argument("-d","--detail",help=" for display all a noc information",action="store_true")
    # parser.add_argument("-er","--employment_requirements",help=" for display employment requirement information",action="store_true")
    # parser.add_argument("-gd","--general_description",help=" for display general description information",action="store_true")
    # parser.add_argument("-ai","--additional_information",help=" for display additional information",action="store_true")
    # parser.add_argument("-ex","--exclusion",help=" for display exclusion information",action="store_true")

    # get data from online for real time data
