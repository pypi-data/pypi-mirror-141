...
def getData(api_url,param_data=None):
    url=base_url+api_url
    response=requests.get(url,params=param_data,headers={'Authorization': "Token c575ff86cdd0385dd504960db9475ba0bcd3da45"})  # jackyzhang.pro
    # response=requests.get(url,params=param_data,headers={'Authorization': "Token cf3da09d2a8c7573c5e1781aa54bc51207899a6e"})  # local
...
def main():
    ...
    data=getData('bcpnp/api/solutions/calculation/',param_data=params)
