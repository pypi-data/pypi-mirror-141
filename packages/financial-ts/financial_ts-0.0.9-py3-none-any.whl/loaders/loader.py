...
class TimeSeriesLoader:
    ...
    * 1min, 5min, 15min, 30min, 60min
    ...
    def ts_intraday(self, interval_minutes=None):
        url = f'{self.source}function={self.function}&symbol={self.symbol}&interval_minutes={self.interval_minutes}min&apikey={self.apikey}&adjusted={self.adjusted}&outputsize={self.outputsize}'
