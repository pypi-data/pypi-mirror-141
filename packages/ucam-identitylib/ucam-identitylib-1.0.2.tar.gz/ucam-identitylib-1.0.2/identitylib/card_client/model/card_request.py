...
class CardRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, identifiers, workflow_state, attributes, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, identifiers, workflow_state, attributes, *args, **kwargs):  # noqa: E501
        """CardRequest - a model defined in OpenAPI
