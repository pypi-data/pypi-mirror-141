...
from hdsr_wis_config_reader.utils import merge_startenddate_idmap
...
def test_merge_startenddate_idmapping(fews_config_local):
    id_mappings = IdMappingCollection(fews_config=fews_config_local)
    df_merged = merge_startenddate_idmap(df_idmap=id_mappings.idmap_all)
