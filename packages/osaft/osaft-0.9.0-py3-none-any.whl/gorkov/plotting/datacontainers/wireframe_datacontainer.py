...
from gorkov.core.functions import (
    spherical_2_cartesian_coordinates as s2c_coord,
)
from gorkov.core.functions import spherical_2_cartesian_vector as s2c_vector
...
class ParticleWireframeData:
    ...
    def get_displacements(self) -> tuple[list, list]:
        ...
        type :class:`gorkov.plotting.wireframe_datacontainer.DeformedLine`.
        """
