...
class BaseVariable(ABC):
    ...
    def name(self) -> str:
        ...
        :setter: sets :attr:`~gorkov.variable.BaseVariable._name`
        """
        return self._name
...
class ActiveVariable(BaseVariable):
    ...
    def value(self) -> Any:
        ...
        :meth:`ActiveVariable._compute` first and then changes
