...
class BaseFrequencyComposite:
    ...
    :class:`~gorkov.core.frequency.Frequency`
    ...
    This class has two purposes:
        ...
        #. Provides an `__init__` methods that handles the `frequency` argument
           ...
           the same instance of :class:`~gorkov.core.frequency.Frequency`.
    ...
    @property
    def f(self) -> float:
        """ wrapper for :attr:`gorkov.core.frequency.Frequency.f`
        """
    ...
    def omega(self) -> float:
        """ wrapper for :attr:`gorkov.core.frequency.Frequency.omega`
        """
        return self.frequency.omega


class BaseSphereFrequencyComposite(BaseFrequencyComposite):
    """ Composite class with :class:`~gorkov.core.frequency.Frequency` and
    :class:`~gorkov.core.geometries.Sphere`
    ...
    This class has two purposes:
        ...
        #. Provides an `__init__` methods that handles the `frequency`
           ...
           :class:`~gorkov.core.frequency.Frequency`
           and :class:`~gorkov.core.geometries.Sphere`.
    ...
    @property
    def R_0(self) -> float:
        """ Wrapper for :attr:`gorkov.core.geometries.Sphere.R_0`
        """
    ...
    @property
    def A(self) -> float:
        """ Wrapper for :attr:`gorkov.core.geometries.Sphere.A`
        """
        return self.sphere.A

    @property
    def V(self) -> float:
        """ Wrapper for :attr:`gorkov.core.geometries.Sphere.V`
        """
