...
from gorkov.core.functions import cos, exp, sin
from gorkov.solutions.Doinikov1994Rigid import ScatteringField
from gorkov.tests.basetest_scattering import (
    HelperCompareScattering,
    HelperScattering,
)
from gorkov.tests.Doinikov1994Rigid.test_base import TestBase


class TestScattering(HelperScattering, TestBase):
    ...
    def test_propertiess(self) -> None:
        properties = ['x', 'x_v', 'mu_1', 'mu_2', 'mu_3', 'mu_4']
    ...
    @property
    def x_v(self):
        return self.R_0 * self.cls.k_v


class TestScatteringCompareToKing(HelperCompareScattering, TestBase):
