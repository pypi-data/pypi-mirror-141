...
from gorkov import Doinikov1994Rigid
from gorkov.core.backgroundfields import WaveTypes, WrongWaveTypeError
from gorkov.core.functions import pi, sin, xexpexp1
...
class TestARFBase(TestBase):
    ...
    def test_properties(self) -> None:
        properties = [
            'x_0', 'norm_delta', 'G_0', 'G_1', 'G_2', 'G_3', 'G_4',
