...
from gorkov import Gorkov1962, King1934, WaveTypes
...
from gorkov.tests.King1934.test_base import BaseKing
...
class TestARF(BaseKing):
    ...
    def test_general_solution(self) -> None:
        for n in range(0, self.n_runs + 3):
            self.cls.N_max = n
            self.do_testing(
                func_1=self.cls.acoustic_radiation_force,
