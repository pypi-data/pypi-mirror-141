...
from gorkov import ARFPlot, Gorkov1962, King1934, WaveTypes, Yosioka1955
from gorkov.solutions.base_arf import BaseARF
from gorkov.tests.basetest_plotting import BaseTestPlotting
...
class TestARFPlot(BaseTestPlotting):
    ...
    def create_solutions(self) -> list[BaseARF]:
        ...
        c_f = 1500
        p_0 = 1e5
        wave_types = WaveTypes.TRAVELLING
        position = None
