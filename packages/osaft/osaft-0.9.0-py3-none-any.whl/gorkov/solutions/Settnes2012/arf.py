...
from gorkov.core.fluids import InviscidFluid, ViscousFluid
...
class ARF(BaseARF, BaseSphereFrequencyComposite, BaseSolution):
    ...
    def rho_s(self) -> float:
        """ Wraps to :attr:`gorkov.core.fluids.InviscidFluid.rho_s`
        """
    ...
    @property
    def c_s(self) -> float:
        """ Wraps to :attr:`gorkov.core.fluids.InviscidFluid.c_s`
        """
    ...
    def kappa_s(self) -> float:
        """ Wraps to :attr:`gorkov.core.fluids.InviscidFluid.kappa_f`
        """
