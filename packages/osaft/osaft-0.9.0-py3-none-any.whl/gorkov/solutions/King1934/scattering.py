...
from gorkov.core.functions import exp
...
from gorkov.solutions.King1934.base import BaseKing


class ScatteringField(BaseKing, BaseScatteringRigidParticle):
    ...
    def V_r_sc(
        ...
        """Implements :meth:`gorkov.solutions.base_scattering.BaseScattering.\
V_r_sc`
        """
