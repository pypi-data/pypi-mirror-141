...
if __name__ == "__main__":
  ...
  class PostEggCommand(egg_info):
    def run(self):
      ...
      # global overwriteconfig
      # if overwriteconfig:
      #   print("Overwriting configuration files")
      #   shutil.copyfile('etc/osidled.conf', '/etc/osidled.conf')
      #   shutil.copyfile('etc/systemd/system/osidled.service', '/etc/systemd/system/osidled.service')
      # else:
      #   print("Configuration files are not overwritten")
