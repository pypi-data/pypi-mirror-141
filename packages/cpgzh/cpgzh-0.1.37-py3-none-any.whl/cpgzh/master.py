...
class Master:
    ...
    def __init__(self, data_path="data.dat") -> None:
        ...
        self.data: Data = Data.load_data(Data, data_path)
        self.data.temp = ""
    ...
    def load_data(self, new_path=None):
        """加载数据"""
        self.data: Data = Data.load_data(Data, new_path or self.data_path)
    ...
    def create_delay_tasks(self, task, seconds=1, times=1, args=()):
        ...
        for i in range(times):
            ...
            self._task_id += 1
            # 将任务加到任务队列
            now_task = Task(self._task_id, time_count, task, args)
