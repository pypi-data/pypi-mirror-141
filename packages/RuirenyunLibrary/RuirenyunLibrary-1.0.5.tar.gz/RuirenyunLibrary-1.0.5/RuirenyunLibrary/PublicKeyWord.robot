...
public_wait_and_mouse_over_element
...
public_wait_and_mouse_out_element
    [Arguments]    ${locator}    ${timeout}=30s    ${error}=${None}
...
public_wait_and_mouse_down_element
    [Arguments]    ${locator}    ${timeout}=30s    ${error}=${None}
...
public_wait_and_mouse_up_element
    [Arguments]    ${locator}    ${timeout}=30s    ${error}=${None}
