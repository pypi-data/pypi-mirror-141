...
class Startup:
    def __init__(Class_Startup_variables):
        try:
            ...
            from pycraft import  Installer
            Class_Startup_variables.mod_Installer__ = Installer
            ...
            Class_Startup_variables.version = "0.9.4-5"
    ...
    def Start():
        ...
        while True:
            if Class_Startup_variables.Command == "saveANDexit":
                ...
                Class_Startup_variables.mod_Installer__.runInstaller()
                Class_Startup_variables.mod_Sys__.exit()
