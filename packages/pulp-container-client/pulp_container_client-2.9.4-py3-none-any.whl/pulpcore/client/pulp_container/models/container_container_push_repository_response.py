...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, name=None, latest_version_href=None, pulp_labels=None, versions_href=None, description=None, retain_repo_versions=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
