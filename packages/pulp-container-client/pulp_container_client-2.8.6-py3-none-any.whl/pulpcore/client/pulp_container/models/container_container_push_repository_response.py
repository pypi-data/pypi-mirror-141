...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, description=None, pulp_created=None, pulp_labels=None, latest_version_href=None, name=None, retain_repo_versions=None, pulp_href=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
