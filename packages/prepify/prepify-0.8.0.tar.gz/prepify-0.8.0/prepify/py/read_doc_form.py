...
#     'headings_notes',
#     '94_liste',
#     'number_of_leaves_note',
#     'number_of_columns_note',
#     'number_of_lines_note',
# )
...
def write_prep_file(filepath: str, to_save: dict, save_as: bool):
    ...
    try:
        ...
        sg.popup_ok('There was a problem deleting the old file before writing the new one. David was not sure if this could happen, but just in case, you get this message instead of a crashing Prepify.', title='Not sure what to say...')
        return
    try:
...
#         return
#     try:
#         with open(f'{values["csntm_id"]}.csntm', 'w', encoding='utf-8') as f:
...
def reveal_add_contents(values: dict, window: sg.Window):
    ...
    if ':' in selection:
        ...
        # new_selection = sg.popup_get_text('Enter contents:', title='Edit Contents', default_text=selection)
    else:
