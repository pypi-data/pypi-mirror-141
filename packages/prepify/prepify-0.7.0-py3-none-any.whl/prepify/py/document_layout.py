...
def content(spacer, big_range):
    ...
    contents_column = [
        ...
        [sg.Checkbox('Etheses', key='has_ektheses', size=spacer, enable_events=True), sg.Input('', key='ektheses_notes', expand_x=True, disabled=True)],
