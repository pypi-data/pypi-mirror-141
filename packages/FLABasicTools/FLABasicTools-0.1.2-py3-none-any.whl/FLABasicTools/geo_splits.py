...
place_ref = r'https://github.com/Fair-Lines-America/FLA_basic_tools/blob/main/data/place_ref.zip'
vtd_ref = r'https://github.com/Fair-Lines-America/FLA_basic_tools/blob/main/data/vtd_ref.zip'
mil_ref = r'https://github.com/Fair-Lines-America/FLA_basic_tools/blob/main/data/mil_ref.csv'
########
#Helper Functions
########
def get_links(url):
