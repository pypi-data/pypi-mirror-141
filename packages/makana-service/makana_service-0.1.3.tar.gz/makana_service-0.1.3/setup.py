...
data_files_spec = [
    ...
    ("share/jupyter/nbextensions/makana_service", [
        "makana_service/nbextension/main.js",
    ]),
    # like `jupyter nbextension enable --sys-prefix`
    ("etc/jupyter/nbconfig/notebook.d", [
        "jupyter-config/nbconfig/notebook.d/makana_service.json"
    ]),
    # like `jupyter serverextension enable --sys-prefix`
    ("etc/jupyter/jupyter_notebook_config.d", [
        "jupyter-config/jupyter_notebook_config.d/makana_service.json"
    ]),
    (
        "etc/jupyter/jupyter_server_config.d",
        ["jupyter-config/jupyter_server_config.d/makana_service.json"]
    ),
    ...
    (
            ...
            [
                "makana_service/nbextension/main.js",
                "makana_service/nbextension/README.md",
                "makana_service/nbextension/jupytext_menu.png",
                "makana_service/nbextension/maknaservice.yml",
            ],
        ),
]
...
if not build_labextension:
    ...
    setup_args["package_data"] = {"makana_service": ["nbextension/*.*"]}
    ...
    lab_path = path.join(this_directory, "makana_service", "labextension")
    nb_path = path.join(this_directory, "makana_service", "nbextension")
    ...
    data_files_spec = [
        # Install nbextension
        ("share/jupyter/nbextensions/makana_service", nb_path, "**"),
        ("share/jupyter/nbextensions/makana_service", nbconfig_path, "makana_service.json"),
        ...
        ("etc/jupyter/nbconfig/notebook.d", nbconfig_path, "makana_service.json"),
        ("share/jupyter/labextensions/%s" % labext_name, str(lab_path.relative_to(HERE)), "**"),
        ("share/jupyter/labextensions/%s" % labext_name, str("."), "install.json"),
    ]
    package_data_spec = {"makana_service": ["nbextension/**"]}
    ...
    cmdclass["jsdeps"] = combine_commands(
        install_npm(
            path.join(this_directory, "makana_service", "labextension"),
