...
class Tapis(object):
    ...
    def __init__(self,
        ...
        # Check that access_token and jwt don't collide. (jwt becomes access_token, but shouldn't overwrite another set access_token)
        if access_token and jwt:
            raise errors.TapyClientConfigurationError("access_token and jwt can't both be inputs to Tapis.")
