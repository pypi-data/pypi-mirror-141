...
from shape_building.airlab.loss import MSE
from shape_building.airlab.regulariser import GaussianRegulariser
from shape_building.airlab.transformation import (
...
from shape_building.airlab.utils import (
    create_image_pyramid,
    upsample_displacement,
    warp_image,
)
from shape_building.logging_tqdm import TqdmToLogger
...
class Registration(LightningLite):
    def run(
        ...
        for _ in tqdm(
            ...
            file=TqdmToLogger(logger=_logger, level=logging.INFO),
