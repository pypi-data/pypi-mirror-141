...
from shape.transforms import TransformShapeValidationMixin

from shape_building.snapping.strategy import SnappingStrategy
...
class SnappingTransform(TransformShapeValidationMixin):
    ...
    def apply_transform(self, subject: shape.ShapeSupportSubject):
