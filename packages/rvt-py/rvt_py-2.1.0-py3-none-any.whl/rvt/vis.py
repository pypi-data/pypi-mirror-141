...
def slope_aspect(dem,
    ...
    if not (1000 >= ve_factor >= -1000):
        raise Exception("rvt.visualization.slope_aspect: ve_factor must be between -1000 and 1000!")
...
def hillshade(dem,
    ...
    if not (1000 >= ve_factor >= -1000):
        raise Exception("rvt.visualization.hillshade: ve_factor must be between -1000 and 1000!")
...
def multi_hillshade(dem,
    ...
    if not (1000 >= ve_factor >= -1000):
        raise Exception("rvt.visualization.multi_hillshade: ve_factor must be between -1000 and 1000!")
...
def slrm(dem,
    ...
    if not (1000 >= ve_factor >= -1000):
        raise Exception("rvt.visualization.slrm: ve_factor must be between -1000 and 1000!")
...
def sky_view_factor(dem,
    ...
    if not (1000 >= ve_factor >= -1000):
        raise Exception("rvt.visualization.sky_view_factor: ve_factor must be between -1000 and 1000!")
...
def local_dominance(dem,
    ...
    if not (1000 >= ve_factor >= -1000):
        raise Exception("rvt.visualization.local_dominance: ve_factor must be between -1000 and 1000!")
...
def sky_illumination(dem,
    ...
    if not (1000 >= ve_factor >= -1000):
        raise Exception("rvt.visualization.sky_illumination: ve_factor must be between -1000 and 1000!")
...
def shadow_horizon(dem,
    ...
    """
    if not (1000 >= ve_factor >= -1000):
        raise Exception("rvt.visualization.shadow_horizon: ve_factor must be between -1000 and 1000!")
    if shadow_az > 360 or shadow_az < 0:
...
def msrm(dem,
    ...
    """
    if not (1000 >= ve_factor >= -1000):
        raise Exception("rvt.visualization.msrm: ve_factor must be between -1000 and 1000!")
    if resolution < 0:
...
def mstp(dem,
    ...
    if not (1000 >= ve_factor >= -1000):
        raise Exception("rvt.visualization.mstp: ve_factor must be between -1000 and 1000!")
