...
_print_exception = console.print_exception


def wrapped_print_exception(*args, **kwargs):
    _print_exception(show_locals=True, extra_lines=6, *args, **kwargs)


console.print_exception = wrapped_print_exception
