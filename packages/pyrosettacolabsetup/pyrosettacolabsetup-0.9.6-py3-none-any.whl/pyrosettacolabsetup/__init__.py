...
def install_pyrosetta(prefix=_DEFAULT_PYROSETTA_INSTALL_PREFIX_):
    ...
    # west mirror
    execute_through_pty(f'wget -c --content-disposition --http-user={login} --http-password={password} https://west.rosettacommons.org/pyrosetta/release/release/release/PyRosetta4.MinSizeRel.python{sys.version_info.major}{sys.version_info.minor}.ubuntu.wheel/.latest')
