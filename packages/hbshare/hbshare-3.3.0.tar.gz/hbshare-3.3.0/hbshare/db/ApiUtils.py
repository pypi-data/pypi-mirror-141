...
def commonQuery(urlEnum, pause=0.01, timeout=10,**kwargs):
    ...
    while page <= pages:
        ...
        org_js = api.query(cfg.url, method=cfg.method, params=params,post_data=post_data)
...
if __name__ == '__main__':
    ...
    data = commonQuery(UrlEnum.FUND_JJHB,jjdm = '000001',startDate='20060104',endDate='20071025')
    print(data)