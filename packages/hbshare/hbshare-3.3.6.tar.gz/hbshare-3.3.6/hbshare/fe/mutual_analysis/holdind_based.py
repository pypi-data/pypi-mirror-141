...
def save_industry_property2localdb(ba,asofdate=datetime.datetime.today().strftime('%Y%m%d'),time_length=3):
    ...
    for jjdm in jjdm_list:
        ...
        try:
            ...
            average_ind_cen_level = ba.centralization_level(inddf,3,5)
            cen_list.append(average_ind_cen_level)

            average_theme_cen_level = ba.centralization_level(themedf,1,2)
            ...
            top5=[ba.industry_name_map_e2c[x.split('_')[0]] for x in  inddf.mean().sort_values()[-5:].index.tolist()]
    ...
    collect_df.rename(columns=ba.industry_name_map_e2c,inplace=True)
...
if __name__ == '__main__':
    ...
    # jjdm_list=util.get_mutual_stock_funds('20211231')
    #
    # #gh.save_holding_trading_2db(jjdm_list, '20190304', '20220304')
