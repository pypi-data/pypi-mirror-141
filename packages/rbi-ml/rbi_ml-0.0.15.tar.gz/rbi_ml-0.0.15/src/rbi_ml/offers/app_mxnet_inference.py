...
def load_model(model_name, model_prefix, model_epoch, context_lookup_names, sequence_lookup_name):
    # lookup tables
    model_path = os.path.join("models/", model_name, model_prefix)
    lookup_paths = {
        k: os.path.join("models/", model_name, k + "_lookup.csv") for k in context_lookup_names + [sequence_lookup_name]
    }
    lookup_tables = {
