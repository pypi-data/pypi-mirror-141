...
def push_config(config_dir: str, aws_profile, aws_region, client_code, environment):
...
def pull_config(config_dir: str, aws_profile, aws_region, client_code, environment):
