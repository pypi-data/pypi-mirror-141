...
from pypos3d.wftk.WFBasic import Point3d, Vector3d, TexCoord2f, existGeom, getOBJFile, LinePlaneInterSect,\
  FaceVisibility, Edge, CoordSyst, FaceNormalOrder, FEPSILON, FEPSILON2, SArcCos, MxProd
...
class Test(unittest.TestCase):
  ...
  #   tbldo0 = [ point3(x=i,y=0.0,z=0.0) for i in range(SIZE) ]
  #   tbldo1 = [ point3(x=i,y=0.0,z=0.0) for i in range(SIZE) ]
  #   c.stopPrint()
  #
  #
