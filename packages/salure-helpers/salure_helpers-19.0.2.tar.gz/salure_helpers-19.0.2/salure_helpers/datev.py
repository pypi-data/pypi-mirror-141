...
class Datev(object):
    ...
    def export_to_template(self, df: pd.DataFrame,
        ...
        template_description = "[Satzbeschreibung]\n"\
                               f"100;u_lod_psd_mitarbeiter;{'pnr_betriebliche#psd' if use_alternative_employee_number else 'pnr#psd'};{'pnr#psd;' if 'employee_id' in df.columns.values else ''}duevo_familienname#psd;duevo_vorname#psd;gebname#psd;adresse_strassenname#psd;adresse_strasse_nr#psd;adresse_plz#psd;adresse_ort#psd;\n" \
