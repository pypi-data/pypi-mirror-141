...
class ClusterClusterWorkload(object):
    ...
    def kernel_cluster_node(self, kernel_cluster_node):
        ...
        """
        if self.local_vars_configuration.client_side_validation and kernel_cluster_node is None:  # noqa: E501
            raise ValueError("Invalid value for `kernel_cluster_node`, must not be `None`")  # noqa: E501
