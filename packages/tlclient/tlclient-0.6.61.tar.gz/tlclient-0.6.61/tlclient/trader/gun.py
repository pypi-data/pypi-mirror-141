...
'''.format(FIST_TYPES)
    ...
    def parse_and_execute(self):
        ...
        self.main_parser.add_argument('--algo_path', action='append', help='algo path of oms')
        self.main_parser.add_argument('--data_impl_file_path', help='data manipulation file path of oms')
        # ------ parser end ------
    ...
    def _run_instance(self, fist_type, args):
        ...
        if fist_type in ['tg', 'mg']:
            ...
            try:
                GunNextOMS(args.algo_path, args.data_impl_file_path, args.fist_name, args.tr_name, args.mr_name).run()
            except Exception:
                print(traceback.format_exc())
                print_fist_fail_mark()
