...
class GunNextOMS:
    ...
    def __init__(self, algo_path: str, data_impl_file_path: str, fist_name, trade_router, market_router):
        if 'OMS_CONFIG_PATH' not in os.environ:
            os.environ['OMS_CONFIG_PATH'] = CONFIG_DEFAULT_PATH

        self._obj = NextOMS(algo_path, data_impl_file_path, fist_name)
