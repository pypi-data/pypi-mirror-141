...
- variant (a value equal to: "default", "filled", "unstyled", "headless"; optional):
    ...
    @_explicitize_args
    def __init__(self, class_name=Component.UNDEFINED, description=Component.UNDEFINED, disabled=Component.UNDEFINED, error=Component.UNDEFINED, icon=Component.UNDEFINED, iconWidth=Component.UNDEFINED, id=Component.UNDEFINED, invalid=Component.UNDEFINED, label=Component.UNDEFINED, multiline=Component.UNDEFINED, placeholder=Component.UNDEFINED, radius=Component.UNDEFINED, required=Component.UNDEFINED, rightSection=Component.UNDEFINED, rightSectionWidth=Component.UNDEFINED, size=Component.UNDEFINED, style=Component.UNDEFINED, value=Component.UNDEFINED, variant=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'class_name', 'description', 'disabled', 'error', 'icon', 'iconWidth', 'invalid', 'label', 'multiline', 'placeholder', 'radius', 'required', 'rightSection', 'rightSectionWidth', 'size', 'style', 'value', 'variant']
        self._type = 'TextInput'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'class_name', 'description', 'disabled', 'error', 'icon', 'iconWidth', 'invalid', 'label', 'multiline', 'placeholder', 'radius', 'required', 'rightSection', 'rightSectionWidth', 'size', 'style', 'value', 'variant']
