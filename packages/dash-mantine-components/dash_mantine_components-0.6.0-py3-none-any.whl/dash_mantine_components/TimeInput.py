...
- withSeconds (boolean; optional):
    ...
    @_explicitize_args
    def __init__(self, amPmPlaceholder=Component.UNDEFINED, class_name=Component.UNDEFINED, clearButtonLabel=Component.UNDEFINED, clearable=Component.UNDEFINED, description=Component.UNDEFINED, disabled=Component.UNDEFINED, error=Component.UNDEFINED, format=Component.UNDEFINED, icon=Component.UNDEFINED, iconWidth=Component.UNDEFINED, id=Component.UNDEFINED, invalid=Component.UNDEFINED, label=Component.UNDEFINED, multiline=Component.UNDEFINED, name=Component.UNDEFINED, persistence=Component.UNDEFINED, persisted_props=Component.UNDEFINED, persistence_type=Component.UNDEFINED, radius=Component.UNDEFINED, required=Component.UNDEFINED, rightSection=Component.UNDEFINED, rightSectionWidth=Component.UNDEFINED, size=Component.UNDEFINED, style=Component.UNDEFINED, timePlaceholder=Component.UNDEFINED, value=Component.UNDEFINED, variant=Component.UNDEFINED, withSeconds=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'amPmPlaceholder', 'class_name', 'clearButtonLabel', 'clearable', 'description', 'disabled', 'error', 'format', 'icon', 'iconWidth', 'invalid', 'label', 'multiline', 'name', 'persisted_props', 'persistence', 'persistence_type', 'radius', 'required', 'rightSection', 'rightSectionWidth', 'size', 'style', 'timePlaceholder', 'value', 'variant', 'withSeconds']
        self._type = 'TimeInput'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'amPmPlaceholder', 'class_name', 'clearButtonLabel', 'clearable', 'description', 'disabled', 'error', 'format', 'icon', 'iconWidth', 'invalid', 'label', 'multiline', 'name', 'persisted_props', 'persistence', 'persistence_type', 'radius', 'required', 'rightSection', 'rightSectionWidth', 'size', 'style', 'timePlaceholder', 'value', 'variant', 'withSeconds']
