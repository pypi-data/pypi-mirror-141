...
_package_data: Dict[str, Any] = dict(
    ...
    version_info=(0, 7, 0),
    __version__='0.7.0',
    version_timestamp='2022-03-05 19:24:30',
...
- convert:
  ...
  - !Opt [keep, !Action store_true, !Help preserve partial .rst on execution error]
...
- roundtrip:
  - !Opt [oitnb, !Action store_true, !Help apply oitnb to !python documents]
  - !Arg [file, nargs: +, !Help files to process]
