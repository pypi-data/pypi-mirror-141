...
(There is currently no postprocessing for Markdown, as pandoc is currentlynot working on Arch (Mark 2022))
...
.. code::
  ...
  /tmp/ryd-of-anthon/ryd-278/tmp_02.nim(4, 5) Hint: 'a' is declared but not used [XDeclaredButNotUsed]
