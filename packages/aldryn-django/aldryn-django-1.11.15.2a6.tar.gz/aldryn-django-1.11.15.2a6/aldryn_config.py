...
class Form(forms.BaseForm):
    ...
    def migration_settings(self, settings, env):
        ...
        # TODO: Re-enable once the backends implement the update functionality
        # from aldryn_addons.utils import boolean_ish
        # from django.core.files.storage import default_storage
        # if hasattr(default_storage, "update_headers"):
        #     for var_name in (
        #         'DISABLE_MEDIA_HEADERS_UPDATE', 'DISABLE_S3_MEDIA_HEADERS_UPDATE'
        #     ):
        #         if boolean_ish(env(var_name)):
        #             break
        #     else:
        #         mcmds.append('python manage.py aldryn_update_media_headers')
