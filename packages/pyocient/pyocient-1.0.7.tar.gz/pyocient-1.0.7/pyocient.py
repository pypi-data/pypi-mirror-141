...
class Cursor:
    ...
    def _decode_entry(self):
        ...
        type_map = {TypeCodes.INT: "!i", TypeCodes.LONG: "!q", TypeCodes.FLOAT: "!f", TypeCodes.DOUBLE: "!d", TypeCodes.BOOLEAN: "?", TypeCodes.SHORT: "!h"}
...
""",
    ...
    parser.add_argument("--format", "-f", type=str, choices=["json", "table"], default="json", help="Output format, defaults to json")
