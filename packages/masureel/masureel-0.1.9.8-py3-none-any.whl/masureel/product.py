...
class Product():
    def __init__(self, record):
        ...
        self.topview_present = True if 'Topview found' in record['fields'].keys(
        ) else False
        self.shader_present = True if 'Shader found' in record['fields'].keys(
        ) else False
        self.data_present = True if 'Database found' in record['fields'].keys(
        ) else False
