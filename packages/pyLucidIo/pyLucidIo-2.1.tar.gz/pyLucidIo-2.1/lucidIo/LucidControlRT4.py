...
class LucidControlRT4(LucidControlRT):
    ...
    def getIo(self, channel, value):
        ...
        """
        return super(LucidControlRT4, self).getIo(channel, value)
    ...
    def getIoGroup(self, channels, values):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlRT4, self).getIoGroup(channels, values)
    ...
    def getParamValue(self, channel, value):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlRT4, self).getParamValue(channel, value)
    ...
    def getParamMode(self, channel, mode):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlRT4, self).getParamMode(channel, mode)
    ...
    def setParamModeDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlRT4, self).setParamModeDefault(channel, persistent)
    ...
    def setParamMode(self, channel, persistent, mode):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range    
        """
        return super(LucidControlRT4, self).setParamMode(channel, persistent, mode)
    ...
    def setParamFlagsDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlRT4, self).setParamFlagsDefault(channel, persistent)
    ...
    def getParamScanInterval(self, channel, scanInterval):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """  
        return super(LucidControlRT4, self).getParamScanInterval(channel, scanInterval)      
    ...
    def setParamScanIntervalDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlRT4, self).setParamScanIntervalDefault(channel, persistent)
    ...
    def setParamScanInterval(self, channel, persistent, scanInterval):
        ...
        """
        return super(LucidControlRT4, self).setParamScanInterval(channel, persistent, scanInterval)
    ...
    def getParamSetupTime(self, channel, setupTime):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """   
        return super(LucidControlRT4, self).getParamSetupTime(channel, setupTime)     
    ...
    def setParamSetupTimeDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlRT4, self).setParamSetupTimeDefault(channel, persistent)
    ...
    def setParamSetupTime(self, channel, persistent, setupTime):
        ...
        """
        return super(LucidControlRT4, self).setParamSetupTime(channel, persistent, setupTime)
    ...
    def getParamOffset(self, channel, offset):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """      
        return super(LucidControlRT4, self).getParamOffset(channel, offset)  
    ...
    def setParamOffsetDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlRT4, self).setParamOffsetDefault(channel, persistent)
    ...
    def setParamOffset(self, channel, persistent, offset):
        ...
        """
        return super(LucidControlRT4, self).setParamOffset(channel, persistent, offset)
    ...
    def getDeviceTypeName(self):
        ...
        """
        return super(LucidControlRT4, self).getDeviceTypeName()
    ...
    def getDeviceType(self):
        ...
        Returns:
            Device type
        """
        return super(LucidControlRT4, self).getDeviceType()
