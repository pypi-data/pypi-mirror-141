...
class LucidControlDO4(LucidControlDO):
    ...
    def getIo(self, channel, value):
        ...
        """
        return super(LucidControlDO4, self).getIo(channel, value)
    ...
    def getIoGroup(self, channels, values):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).getIoGroup(channels, values)
    ...
    def setIo(self, channel, value):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setIo(channel, value)
    ...
    def setIoGroup(self, channels, values):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setIoGroup(channels, values)
    ...
    def getParamValue(self, channel, value):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).getParamValue(channel, value)
    ...
    def setParamValueDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setParamValueDefault(channel, persistent)

    
    def setParamValue(self, channel, persistent, value):
        return super(LucidControlDO4, self).setParamValue(channel, persistent, value)
    ...
    def getParamMode(self, channel, mode):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).getParamMode(channel, mode)
    ...
    def setParamModeDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setParamModeDefault(channel, persistent)
    ...
    def setParamMode(self, channel, persistent, mode):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range    
        """
        return super(LucidControlDO4, self).setParamMode(channel, persistent, mode)
    ...
    def setParamFlagsDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setParamFlagsDefault(channel, persistent)
    ...
    def getParamFlagCanCancel(self, channel, canCancel):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).getParamFlagCanCancel(channel, canCancel)
    ...
    def setParamFlagCanCancel(self, channel, persistent, canCancel):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setParamFlagCanCancel(channel, persistent, canCancel)
    ...
    def getParamFlagCanRetrigger(self, channel, canRetrigger):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).getParamFlagCanRetrigger(channel, canRetrigger)
    ...
    def setParamFlagCanRetrigger(self, channel, persistent, canRetrigger):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setParamFlagCanRetrigger(channel, persistent, canRetrigger)
    ...
    def getParamFlagInverted(self, channel, inverted):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).getParamFlagInverted(channel, inverted)
    ...
    def setParamFlagInverted(self, channel, persistent, inverted):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setParamFlagInverted(channel, persistent, inverted)
    ...
    def getParamCycleTime(self, channel, cycleTime):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).getParamCycleTime(channel, cycleTime)
    ...
    def setParamCycleTimeDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setParamCycleTimeDefault(channel, persistent)
    ...
    def setParamCycleTime(self, channel, persistent, cycleTime):
        ...
        """
        return super(LucidControlDO4, self).setParamCycleTime(channel, persistent, cycleTime)
    ...
    def getParamDutyCycle(self, channel, dutyCycle):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).getParamDutyCycle(channel, dutyCycle)
    ...
    def setParamDutyCycleDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setParamDutyCycleDefault(channel, persistent)
    ...
    def setParamDutyCycle(self, channel, persistent, dutyCycle):
        ...
        """
        return super(LucidControlDO4, self).setParamDutyCycle(channel, persistent, dutyCycle)
    ...
    def getParamOnHold(self, channel, onHold):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).getParamOnHold(channel, onHold)
    ...
    def setParamOnHoldDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setParamOnHoldDefault(channel, persistent)
    ...
    def setParamOnHold(self, channel, persistent, onHold):
        ...
        """
        return super(LucidControlDO4, self).setParamOnHold(channel, persistent, onHold)
    ...
    def getParamOnDelay(self, channel, onDelay):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).getParamOnDelay(channel, onDelay)
    ...
    def setParamOnDelayDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super(LucidControlDO4, self).setParamOnDelayDefault(channel, persistent)
    ...
    def setParamOnDelay(self, channel, persistent, onDelay):
        ...
        """
        return super(LucidControlDO4, self).setParamOnDelay(channel, persistent, onDelay)
    ...
    def getDeviceTypeName(self):
        ...
        """
        return super(LucidControlDO4, self).getDeviceTypeName()
    ...
    def getDeviceType(self):
        ...
        Returns:
            Device type
        """
        return super(LucidControlDO4, self).getDeviceType()
