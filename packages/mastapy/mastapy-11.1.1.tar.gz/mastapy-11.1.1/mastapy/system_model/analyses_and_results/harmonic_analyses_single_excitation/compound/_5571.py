...
class ConnectionCompoundHarmonicAnalysisOfSingleExcitation(_7259.ConnectionCompoundAnalysis):
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5441.ConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5441.ConnectionHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5441.ConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5441.ConnectionHarmonicAnalysisOfSingleExcitation))
        return value
