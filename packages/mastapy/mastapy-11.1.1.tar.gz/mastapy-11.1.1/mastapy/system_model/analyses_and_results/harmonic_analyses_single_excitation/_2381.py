...
class ModalAnalysisForHarmonicAnalysis(_2378.ModalAnalysis):
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5749.HarmonicAnalysisOptions':
        ...
        if _5749.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
