...
class MassDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3232.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''MassDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3055.MassDiscSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3055.MassDiscSteadyStateSynchronousResponseAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3055.MassDiscSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3055.MassDiscSteadyStateSynchronousResponseAtASpeed))
        return value
