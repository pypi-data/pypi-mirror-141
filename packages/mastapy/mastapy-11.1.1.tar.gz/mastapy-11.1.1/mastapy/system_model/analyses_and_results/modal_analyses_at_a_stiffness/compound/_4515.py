...
class PartCompoundModalAnalysisAtAStiffness(_7266.PartCompoundAnalysis):
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4386.PartModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4386.PartModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4386.PartModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4386.PartModalAnalysisAtAStiffness))
        return value
