...
class RollingRingConnectionCompoundModalAnalysisAtAStiffness(_4501.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    '''RollingRingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4399.RollingRingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4399.RollingRingConnectionModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4399.RollingRingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4399.RollingRingConnectionModalAnalysisAtAStiffness))
        return value
