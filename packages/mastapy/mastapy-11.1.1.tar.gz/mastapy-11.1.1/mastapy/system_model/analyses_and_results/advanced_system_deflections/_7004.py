...
class BevelDifferentialGearAdvancedSystemDeflection(_7009.BevelGearAdvancedSystemDeflection):
    ...
    @property
    def component_detailed_analysis_of_type_straight_bevel_gear_rating(self) -> '_367.StraightBevelGearRating':
        ...
        if _367.StraightBevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
