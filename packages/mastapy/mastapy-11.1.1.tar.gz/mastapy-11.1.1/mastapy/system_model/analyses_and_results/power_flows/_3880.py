...
class StraightBevelGearPowerFlow(_3785.BevelGearPowerFlow):
    ...
    @property
    def component_detailed_analysis(self) -> '_367.StraightBevelGearRating':
        ...
        return constructor.new(_367.StraightBevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
