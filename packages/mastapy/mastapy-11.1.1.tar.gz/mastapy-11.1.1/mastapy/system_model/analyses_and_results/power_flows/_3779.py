...
class BevelDifferentialGearMeshPowerFlow(_3784.BevelGearMeshPowerFlow):
    ...
    @property
    def component_detailed_analysis_of_type_straight_bevel_gear_mesh_rating(self) -> '_366.StraightBevelGearMeshRating':
        ...
        if _366.StraightBevelGearMeshRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
