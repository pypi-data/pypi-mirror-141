...
class SynchroniserPartCompoundHarmonicAnalysis(_5897.CouplingHalfCompoundHarmonicAnalysis):
    '''SynchroniserPartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5808.SynchroniserPartHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5808.SynchroniserPartHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5808.SynchroniserPartHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5808.SynchroniserPartHarmonicAnalysis))
        return value
