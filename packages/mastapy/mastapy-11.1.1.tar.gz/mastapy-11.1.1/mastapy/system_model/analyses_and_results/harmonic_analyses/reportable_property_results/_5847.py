...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5840, _5845
...
class ResultsForMultipleOrdersForGroups(_5845.ResultsForMultipleOrders):
    '''ResultsForMultipleOrdersForGroups
    ...
    @property
    def groups(self) -> 'List[_5840.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Groups, constructor.new(_5840.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic))
        return value
