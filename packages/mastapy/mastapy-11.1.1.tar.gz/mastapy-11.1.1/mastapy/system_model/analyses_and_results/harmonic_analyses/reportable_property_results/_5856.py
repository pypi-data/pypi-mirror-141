...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5849, _5833
...
class RootAssemblySingleWhineAnalysisResultsPropertyAccessor(_5833.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''RootAssemblySingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5849.ResultsForOrderIncludingGroups]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5849.ResultsForOrderIncludingGroups))
        return value
