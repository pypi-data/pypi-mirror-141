...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5851, _5857
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5857.SingleWhineAnalysisResultsPropertyAccessor):
    '''FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5851.ResultsForOrderIncludingSurfaces]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5851.ResultsForOrderIncludingSurfaces))
        return value
