...
class TorqueConverterCompoundHarmonicAnalysis(_5895.CouplingCompoundHarmonicAnalysis):
    '''TorqueConverterCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5811.TorqueConverterHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5811.TorqueConverterHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5811.TorqueConverterHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5811.TorqueConverterHarmonicAnalysis))
        return value
