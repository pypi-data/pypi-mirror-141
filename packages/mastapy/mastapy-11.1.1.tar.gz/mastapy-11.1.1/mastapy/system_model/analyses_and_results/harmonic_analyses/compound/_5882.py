...
class CoaxialConnectionCompoundHarmonicAnalysis(_5955.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    '''CoaxialConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5690.CoaxialConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5690.CoaxialConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5690.CoaxialConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5690.CoaxialConnectionHarmonicAnalysis))
        return value
