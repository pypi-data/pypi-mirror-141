...
class StraightBevelGearMeshSystemDeflection(_2444.BevelGearMeshSystemDeflection):
    ...
    @property
    def rating(self) -> '_366.StraightBevelGearMeshRating':
        ...
        return constructor.new(_366.StraightBevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None

    @property
    def component_detailed_analysis(self) -> '_366.StraightBevelGearMeshRating':
        ...
        return constructor.new(_366.StraightBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
