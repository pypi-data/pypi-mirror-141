...
class ConnectionCompoundModalAnalysis(_7259.ConnectionCompoundAnalysis):
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4858.ConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4858.ConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4858.ConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4858.ConnectionModalAnalysis))
        return value
