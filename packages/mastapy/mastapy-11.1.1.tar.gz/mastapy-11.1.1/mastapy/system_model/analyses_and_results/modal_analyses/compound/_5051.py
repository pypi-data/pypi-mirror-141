...
class MassDiscCompoundModalAnalysis(_5098.VirtualComponentCompoundModalAnalysis):
    '''MassDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4900.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4900.MassDiscModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4900.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4900.MassDiscModalAnalysis))
        return value
