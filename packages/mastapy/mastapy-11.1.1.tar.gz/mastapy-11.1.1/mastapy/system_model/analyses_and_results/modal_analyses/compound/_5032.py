...
class FEPartCompoundModalAnalysis(_4978.AbstractShaftOrHousingCompoundModalAnalysis):
    '''FEPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4880.FEPartModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4880.FEPartModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4880.FEPartModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4880.FEPartModalAnalysis))
        return value
