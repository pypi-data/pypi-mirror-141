...
class RingPinsCompoundModalAnalysis(_5053.MountableComponentCompoundModalAnalysis):
    '''RingPinsCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4918.RingPinsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4918.RingPinsModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4918.RingPinsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4918.RingPinsModalAnalysis))
        return value
