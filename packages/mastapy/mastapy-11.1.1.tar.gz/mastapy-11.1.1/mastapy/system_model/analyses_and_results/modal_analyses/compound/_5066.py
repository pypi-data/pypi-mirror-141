...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5041
...
class RingPinsToDiscConnectionCompoundModalAnalysis(_5041.InterMountableComponentConnectionCompoundModalAnalysis):
    '''RingPinsToDiscConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4919.RingPinsToDiscConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4919.RingPinsToDiscConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4919.RingPinsToDiscConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4919.RingPinsToDiscConnectionModalAnalysis))
        return value
