...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis(_5009.ConicalGearMeshCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4891.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4891.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4891.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4891.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis))
        return value
