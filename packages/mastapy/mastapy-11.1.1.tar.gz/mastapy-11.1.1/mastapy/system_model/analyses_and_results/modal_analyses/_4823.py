...
from mastapy.system_model.analyses_and_results.modal_analyses import _4848, _4883, _4908
...
class AbstractAssemblyModalAnalysis(_4908.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4848.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4848.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4883.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4883.GearMeshModalAnalysis))
        return value
