...
class UnbalancedMassCompoundModalAnalysis(_5098.VirtualComponentCompoundModalAnalysis):
    '''UnbalancedMassCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4951.UnbalancedMassModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4951.UnbalancedMassModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4951.UnbalancedMassModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4951.UnbalancedMassModalAnalysis))
        return value
