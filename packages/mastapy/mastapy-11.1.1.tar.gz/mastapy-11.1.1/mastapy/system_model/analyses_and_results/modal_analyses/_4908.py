...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4975, _4972, _4974
...
class PartModalAnalysis(_7268.PartStaticLoadAnalysisCase):
    ...
    @property
    def results_for_modes(self) -> 'List[_4975.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4975.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4972.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4972.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4972.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4972.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def excited_modes_summary(self) -> 'List[_4974.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4974.SingleExcitationResultsModalAnalysis))
        return value
