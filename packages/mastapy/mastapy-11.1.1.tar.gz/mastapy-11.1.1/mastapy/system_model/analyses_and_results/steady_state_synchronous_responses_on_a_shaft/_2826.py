...
class SteadyStateSynchronousResponseOnAShaft(_7270.StaticLoadAnalysisCase):
    ...
    @property
    def options(self) -> '_3347.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3347.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options is not None else None
