...
class PartSteadyStateSynchronousResponseOnAShaft(_7268.PartStaticLoadAnalysisCase):
    ...
    @property
    def steady_state_synchronous_response_on_a_shaft(self) -> '_2826.SteadyStateSynchronousResponseOnAShaft':
        ...
        return constructor.new(_2826.SteadyStateSynchronousResponseOnAShaft)(self.wrapped.SteadyStateSynchronousResponseOnAShaft) if self.wrapped.SteadyStateSynchronousResponseOnAShaft is not None else None
