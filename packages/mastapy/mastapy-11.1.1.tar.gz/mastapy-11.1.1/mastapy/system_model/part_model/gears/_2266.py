...
class ConicalGear(_2273.Gear):
    ...
    @property
    def active_gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_919.StraightBevelDiffGearDesign':
        ...
        if _919.StraightBevelDiffGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def active_gear_design_of_type_straight_bevel_gear_design(self) -> '_923.StraightBevelGearDesign':
        ...
        if _923.StraightBevelGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_919.StraightBevelDiffGearDesign':
        ...
        if _919.StraightBevelDiffGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_straight_bevel_gear_design(self) -> '_923.StraightBevelGearDesign':
        ...
        if _923.StraightBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
