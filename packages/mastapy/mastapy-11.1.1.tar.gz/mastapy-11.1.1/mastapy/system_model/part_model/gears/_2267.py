...
class ConicalGearSet(_2275.GearSet):
    ...
    @property
    def active_gear_set_design_of_type_straight_bevel_diff_gear_set_design(self) -> '_921.StraightBevelDiffGearSetDesign':
        ...
        if _921.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_straight_bevel_gear_set_design(self) -> '_925.StraightBevelGearSetDesign':
        ...
        if _925.StraightBevelGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_straight_bevel_diff_gear_set_design(self) -> '_921.StraightBevelDiffGearSetDesign':
        ...
        if _921.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_straight_bevel_gear_set_design(self) -> '_925.StraightBevelGearSetDesign':
        ...
        if _925.StraightBevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
