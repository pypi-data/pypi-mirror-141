...
from mastapy.utility.report import _1542, _1543
...
T = TypeVar('T', bound='_1543.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1542.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
