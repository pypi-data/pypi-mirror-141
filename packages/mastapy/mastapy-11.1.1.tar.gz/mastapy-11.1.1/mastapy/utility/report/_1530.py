...
class CustomReport(_1540.CustomReportItemContainer):
    '''CustomReport
    ...
    @property
    def cad_table_border_style(self) -> '_1525.CadTableBorderType':
        ...
        return constructor.new(_1525.CadTableBorderType)(value) if value is not None else None

    @cad_table_border_style.setter
    def cad_table_border_style(self, value: '_1525.CadTableBorderType'):
    ...
    @property
    def page_size_for_cad_export(self) -> '_1524.CadPageSize':
        ...
        return constructor.new(_1524.CadPageSize)(value) if value is not None else None

    @page_size_for_cad_export.setter
    def page_size_for_cad_export(self, value: '_1524.CadPageSize'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def include_report_check(self) -> '_1557.DefinitionBooleanCheckOptions':
        ...
        return constructor.new(_1557.DefinitionBooleanCheckOptions)(value) if value is not None else None

    @include_report_check.setter
    def include_report_check(self, value: '_1557.DefinitionBooleanCheckOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
