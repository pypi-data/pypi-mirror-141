...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _704, _709, _707
...
class CylindricalGearHobDesign(_691.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def nominal_hob_shape(self) -> '_704.CylindricalGearHobShape':
        ...
        return constructor.new(_704.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape is not None else None

    @property
    def nominal_rack_shape(self) -> '_709.RackShape':
        ...
        if _709.RackShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_704.CylindricalGearHobShape':
        ...
        if _704.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_707.CylindricalGearWormGrinderShape':
        ...
        if _707.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def maximum_hob_material_shape(self) -> '_704.CylindricalGearHobShape':
        ...
        return constructor.new(_704.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape is not None else None

    @property
    def minimum_hob_material_shape(self) -> '_704.CylindricalGearHobShape':
        ...
        return constructor.new(_704.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape is not None else None
