...
class CylindricalGearManufacturingConfig(_1168.GearImplementationDetail):
    ...
    @property
    def rough_cutter(self) -> '_692.CylindricalGearRealCutterDesign':
        ...
        if _692.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_686.CylindricalGearFormGrindingWheel':
        ...
        if _686.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_687.CylindricalGearGrindingWorm':
        ...
        if _687.CylindricalGearGrindingWorm.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_hob_design(self) -> '_688.CylindricalGearHobDesign':
        ...
        if _688.CylindricalGearHobDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_689.CylindricalGearPlungeShaver':
        ...
        if _689.CylindricalGearPlungeShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_rack_design(self) -> '_691.CylindricalGearRackDesign':
        ...
        if _691.CylindricalGearRackDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_shaper(self) -> '_693.CylindricalGearShaper':
        ...
        if _693.CylindricalGearShaper.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_shaver(self) -> '_694.CylindricalGearShaver':
        ...
        if _694.CylindricalGearShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_involute_cutter_design(self) -> '_697.InvoluteCutterDesign':
        ...
        if _697.InvoluteCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter(self) -> '_692.CylindricalGearRealCutterDesign':
        ...
        if _692.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_686.CylindricalGearFormGrindingWheel':
        ...
        if _686.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_687.CylindricalGearGrindingWorm':
        ...
        if _687.CylindricalGearGrindingWorm.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_hob_design(self) -> '_688.CylindricalGearHobDesign':
        ...
        if _688.CylindricalGearHobDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_689.CylindricalGearPlungeShaver':
        ...
        if _689.CylindricalGearPlungeShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_rack_design(self) -> '_691.CylindricalGearRackDesign':
        ...
        if _691.CylindricalGearRackDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_shaper(self) -> '_693.CylindricalGearShaper':
        ...
        if _693.CylindricalGearShaper.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_shaver(self) -> '_694.CylindricalGearShaver':
        ...
        if _694.CylindricalGearShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_involute_cutter_design(self) -> '_697.InvoluteCutterDesign':
        ...
        if _697.InvoluteCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation(self) -> '_672.GearCutterSimulation':
        ...
        if _672.GearCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_669.FinishCutterSimulation':
        ...
        if _669.FinishCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_677.RoughCutterSimulation':
        ...
        if _677.RoughCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation(self) -> '_672.GearCutterSimulation':
        ...
        if _672.GearCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_669.FinishCutterSimulation':
        ...
        if _669.FinishCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_677.RoughCutterSimulation':
        ...
        if _677.RoughCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_gear_specification(self) -> '_666.CylindricalGearSpecification':
        ...
        return constructor.new(_666.CylindricalGearSpecification)(self.wrapped.RoughGearSpecification) if self.wrapped.RoughGearSpecification is not None else None

    @property
    def finished_gear_specification(self) -> '_666.CylindricalGearSpecification':
        ...
        return constructor.new(_666.CylindricalGearSpecification)(self.wrapped.FinishedGearSpecification) if self.wrapped.FinishedGearSpecification is not None else None
    ...
    @property
    def rough_manufacturing_process_controls(self) -> '_675.ManufacturingProcessControls':
        ...
        return constructor.new(_675.ManufacturingProcessControls)(self.wrapped.RoughManufacturingProcessControls) if self.wrapped.RoughManufacturingProcessControls is not None else None

    @property
    def finish_manufacturing_process_controls(self) -> '_675.ManufacturingProcessControls':
        ...
        return constructor.new(_675.ManufacturingProcessControls)(self.wrapped.FinishManufacturingProcessControls) if self.wrapped.FinishManufacturingProcessControls is not None else None
