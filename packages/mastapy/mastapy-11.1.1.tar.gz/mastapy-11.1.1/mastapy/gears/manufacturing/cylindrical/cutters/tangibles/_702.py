...
class CutterShapeDefinition(_0.APIBase):
    ...
    @property
    def design(self) -> '_692.CylindricalGearRealCutterDesign':
        ...
        if _692.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_686.CylindricalGearFormGrindingWheel':
        ...
        if _686.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_grinding_worm(self) -> '_687.CylindricalGearGrindingWorm':
        ...
        if _687.CylindricalGearGrindingWorm.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_hob_design(self) -> '_688.CylindricalGearHobDesign':
        ...
        if _688.CylindricalGearHobDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_plunge_shaver(self) -> '_689.CylindricalGearPlungeShaver':
        ...
        if _689.CylindricalGearPlungeShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_rack_design(self) -> '_691.CylindricalGearRackDesign':
        ...
        if _691.CylindricalGearRackDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaper(self) -> '_693.CylindricalGearShaper':
        ...
        if _693.CylindricalGearShaper.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaver(self) -> '_694.CylindricalGearShaver':
        ...
        if _694.CylindricalGearShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_involute_cutter_design(self) -> '_697.InvoluteCutterDesign':
        ...
        if _697.InvoluteCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def fillet_points(self) -> 'List[_708.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FilletPoints, constructor.new(_708.NamedPoint))
        return value

    @property
    def main_blade_points(self) -> 'List[_708.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainBladePoints, constructor.new(_708.NamedPoint))
        return value
