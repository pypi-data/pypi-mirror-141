...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _705
...
class ShaperSimulationCalculator(_664.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_705.CylindricalGearShaperTangible':
        ...
        return constructor.new(_705.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper is not None else None
