...
class WormGrinderSimulationCalculator(_676.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self) -> '_707.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_707.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder is not None else None
