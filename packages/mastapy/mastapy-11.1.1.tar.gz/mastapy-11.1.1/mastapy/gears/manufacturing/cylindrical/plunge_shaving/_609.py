...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def input_gear_geometry(self) -> '_665.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_665.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry is not None else None
