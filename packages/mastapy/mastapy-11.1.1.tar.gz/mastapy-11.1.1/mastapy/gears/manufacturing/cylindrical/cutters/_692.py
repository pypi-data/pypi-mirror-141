...
from mastapy.gears.manufacturing.cylindrical.cutters import _683, _685
...
class CylindricalGearRealCutterDesign(_685.CylindricalGearAbstractCutterDesign):
    '''CylindricalGearRealCutterDesign
    ...
    @property
    def nominal_cutter_shape(self) -> '_702.CutterShapeDefinition':
        ...
        if _702.CutterShapeDefinition.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_formed_wheel_grinder_tangible(self) -> '_703.CylindricalGearFormedWheelGrinderTangible':
        ...
        if _703.CylindricalGearFormedWheelGrinderTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_hob_shape(self) -> '_704.CylindricalGearHobShape':
        ...
        if _704.CylindricalGearHobShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaper_tangible(self) -> '_705.CylindricalGearShaperTangible':
        ...
        if _705.CylindricalGearShaperTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaver_tangible(self) -> '_706.CylindricalGearShaverTangible':
        ...
        if _706.CylindricalGearShaverTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_707.CylindricalGearWormGrinderShape':
        ...
        if _707.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_rack_shape(self) -> '_709.RackShape':
        ...
        if _709.RackShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def customised_cutting_edge_profile(self) -> '_683.CustomisableEdgeProfile':
        ...
        return constructor.new(_683.CustomisableEdgeProfile)(self.wrapped.CustomisedCuttingEdgeProfile) if self.wrapped.CustomisedCuttingEdgeProfile is not None else None
