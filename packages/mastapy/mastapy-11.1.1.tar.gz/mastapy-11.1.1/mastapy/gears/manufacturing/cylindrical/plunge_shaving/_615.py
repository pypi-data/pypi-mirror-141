...
class RealPlungeShaverOutputs(_612.PlungeShaverOutputs):
    ...
    @property
    def shaver(self) -> '_689.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_689.CylindricalGearPlungeShaver)(self.wrapped.Shaver) if self.wrapped.Shaver is not None else None
