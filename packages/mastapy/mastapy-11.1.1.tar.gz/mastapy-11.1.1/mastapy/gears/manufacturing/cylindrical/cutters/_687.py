...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _707, _709, _704
...
class CylindricalGearGrindingWorm(_691.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_707.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_707.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape is not None else None
