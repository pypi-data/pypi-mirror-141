...
class GearSetOptimiserCandidate(_868.DesignSpaceSearchCandidateBase['_322.AbstractGearSetRating', 'GearSetOptimiserCandidate']):
    ...
    @property
    def candidate_of_type_straight_bevel_diff_gear_set_rating(self) -> '_364.StraightBevelDiffGearSetRating':
        ...
        if _364.StraightBevelDiffGearSetRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
    ...
    @property
    def candidate_of_type_straight_bevel_gear_set_rating(self) -> '_368.StraightBevelGearSetRating':
        ...
        if _368.StraightBevelGearSetRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
