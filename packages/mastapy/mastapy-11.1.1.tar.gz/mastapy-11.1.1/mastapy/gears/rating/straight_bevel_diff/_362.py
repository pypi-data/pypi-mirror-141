...
from mastapy.gears.rating.straight_bevel_diff import _365, _363
...
class StraightBevelDiffGearMeshRating(_500.ConicalGearMeshRating):
    ...
    @property
    def straight_bevel_diff_gear_mesh(self) -> '_920.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_920.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMesh) if self.wrapped.StraightBevelDiffGearMesh is not None else None

    @property
    def meshed_gears(self) -> 'List[_365.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_365.StraightBevelDiffMeshedGearRating))
        return value

    @property
    def gears_in_mesh(self) -> 'List[_365.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsInMesh, constructor.new(_365.StraightBevelDiffMeshedGearRating))
        return value

    @property
    def straight_bevel_diff_gear_ratings(self) -> 'List[_363.StraightBevelDiffGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearRatings, constructor.new(_363.StraightBevelDiffGearRating))
        return value
