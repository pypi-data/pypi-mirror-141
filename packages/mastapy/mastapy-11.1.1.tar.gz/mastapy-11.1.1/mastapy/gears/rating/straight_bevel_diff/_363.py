...
class StraightBevelDiffGearRating(_501.ConicalGearRating):
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_919.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_919.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear is not None else None
