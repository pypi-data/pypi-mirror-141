...
from mastapy.gears.gear_designs.straight_bevel_diff import _921, _919, _922
...
class StraightBevelDiffGearMeshDesign(_1130.BevelGearMeshDesign):
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_919.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_919.StraightBevelDiffGearDesign))
        return value

    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_922.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_922.StraightBevelDiffMeshedGearDesign))
        return value
