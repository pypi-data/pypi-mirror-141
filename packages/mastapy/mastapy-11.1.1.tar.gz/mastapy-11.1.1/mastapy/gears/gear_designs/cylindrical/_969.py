...
class CylindricalGearDefaults(_1390.PerMachineSettings):
    ...
    @property
    def rough_cutter_creation_settings(self) -> '_701.RoughCutterCreationSettings':
        ...
        return constructor.new(_701.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings is not None else None
