...
class StraightBevelGearMeshRating(_515.BevelGearMeshRating):
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_924.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_924.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh is not None else None
