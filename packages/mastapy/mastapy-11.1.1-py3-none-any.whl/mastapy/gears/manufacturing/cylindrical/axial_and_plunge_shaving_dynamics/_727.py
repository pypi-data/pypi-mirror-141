...
from mastapy.gears.manufacturing.cylindrical.cutters import _694, _689
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def designed_gear(self) -> '_665.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_665.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear is not None else None

    @property
    def shaver(self) -> '_694.CylindricalGearShaver':
        ...
        if _694.CylindricalGearShaver.TYPE not in self.wrapped.Shaver.__class__.__mro__:
    ...
    @property
    def life_shaver(self) -> '_694.CylindricalGearShaver':
        ...
        if _694.CylindricalGearShaver.TYPE not in self.wrapped.LifeShaver.__class__.__mro__:
