...
class CylindricalGearShaperTangible(_702.CutterShapeDefinition):
    '''CylindricalGearShaperTangible
    ...
    @property
    def design(self) -> '_693.CylindricalGearShaper':
        ...
        return constructor.new(_693.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design is not None else None
