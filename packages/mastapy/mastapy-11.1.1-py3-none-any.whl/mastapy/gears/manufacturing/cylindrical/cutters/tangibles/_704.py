...
class CylindricalGearHobShape(_709.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_688.CylindricalGearHobDesign':
        ...
        return constructor.new(_688.CylindricalGearHobDesign)(self.wrapped.Design) if self.wrapped.Design is not None else None
