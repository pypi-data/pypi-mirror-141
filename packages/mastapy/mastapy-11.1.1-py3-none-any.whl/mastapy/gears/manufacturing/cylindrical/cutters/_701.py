...
class RoughCutterCreationSettings(_0.APIBase):
    ...
    @property
    def rough_tool_clearances(self) -> '_674.ManufacturingOperationConstraints':
        ...
        return constructor.new(_674.ManufacturingOperationConstraints)(self.wrapped.RoughToolClearances) if self.wrapped.RoughToolClearances is not None else None

    @property
    def finish_tool_clearances(self) -> '_674.ManufacturingOperationConstraints':
        ...
        return constructor.new(_674.ManufacturingOperationConstraints)(self.wrapped.FinishToolClearances) if self.wrapped.FinishToolClearances is not None else None
