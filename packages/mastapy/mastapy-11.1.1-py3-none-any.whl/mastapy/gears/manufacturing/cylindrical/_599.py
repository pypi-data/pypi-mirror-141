...
class SuitableCutterSetup(_0.APIBase):
    ...
    @property
    def tool_clearances(self) -> '_674.ManufacturingOperationConstraints':
        ...
        return constructor.new(_674.ManufacturingOperationConstraints)(self.wrapped.ToolClearances) if self.wrapped.ToolClearances is not None else None
