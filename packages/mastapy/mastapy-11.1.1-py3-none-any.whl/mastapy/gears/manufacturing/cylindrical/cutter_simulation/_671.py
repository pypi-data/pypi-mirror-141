...
class FormWheelGrindingSimulationCalculator(_664.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_703.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_703.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel is not None else None
