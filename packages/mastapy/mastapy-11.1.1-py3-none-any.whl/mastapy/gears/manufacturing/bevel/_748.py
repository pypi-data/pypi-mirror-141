...
class ConicalMeshMicroGeometryConfigBase(_1172.GearMeshImplementationDetail):
    ...
    @property
    def mesh_of_type_straight_bevel_diff_gear_mesh_design(self) -> '_920.StraightBevelDiffGearMeshDesign':
        ...
        if _920.StraightBevelDiffGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
    ...
    @property
    def mesh_of_type_straight_bevel_gear_mesh_design(self) -> '_924.StraightBevelGearMeshDesign':
        ...
        if _924.StraightBevelGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
