...
from mastapy.utility.reporting_property_framework import _1520
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def chart_type(self) -> '_1520.CustomChartType':
        ...
        return constructor.new(_1520.CustomChartType)(value) if value is not None else None
