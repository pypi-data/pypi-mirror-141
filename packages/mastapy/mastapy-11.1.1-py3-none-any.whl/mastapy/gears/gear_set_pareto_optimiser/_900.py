...
class StraightBevelGearSetParetoOptimiser(_873.GearSetParetoOptimiser):
    ...
    @property
    def selected_candidate_geometry(self) -> '_925.StraightBevelGearSetDesign':
        ...
        return constructor.new(_925.StraightBevelGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry is not None else None

    @property
    def candidate_gear_sets(self) -> 'List[_925.StraightBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_925.StraightBevelGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_925.StraightBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_925.StraightBevelGearSetDesign))
        return value
