...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def shaper_for_agma_rating(self) -> '_693.CylindricalGearShaper':
        ...
        return constructor.new(_693.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating is not None else None
