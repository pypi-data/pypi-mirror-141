...
from mastapy.gears.gear_designs.straight_bevel_diff import _919, _920
...
class StraightBevelDiffGearSetDesign(_1131.BevelGearSetDesign):
    ...
    @property
    def gears(self) -> 'List[_919.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_919.StraightBevelDiffGearDesign))
        return value
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_920.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_920.StraightBevelDiffGearMeshDesign))
        return value
