...
class GearMeshDesign(_906.GearDesignComponent):
    ...
    @property
    def gear_a_of_type_straight_bevel_diff_gear_design(self) -> '_919.StraightBevelDiffGearDesign':
        ...
        if _919.StraightBevelDiffGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_straight_bevel_gear_design(self) -> '_923.StraightBevelGearDesign':
        ...
        if _923.StraightBevelGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_straight_bevel_diff_gear_design(self) -> '_919.StraightBevelDiffGearDesign':
        ...
        if _919.StraightBevelDiffGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_straight_bevel_gear_design(self) -> '_923.StraightBevelGearDesign':
        ...
        if _923.StraightBevelGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
