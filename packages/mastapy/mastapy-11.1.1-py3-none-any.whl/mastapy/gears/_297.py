...
from mastapy.gears.rating.straight_bevel_diff import _364
...
class GearSetOptimisationResult(_0.APIBase):
    ...
    @property
    def gear_set_of_type_straight_bevel_diff_gear_set_design(self) -> '_921.StraightBevelDiffGearSetDesign':
        ...
        if _921.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_straight_bevel_gear_set_design(self) -> '_925.StraightBevelGearSetDesign':
        ...
        if _925.StraightBevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def rating_of_type_straight_bevel_diff_gear_set_rating(self) -> '_364.StraightBevelDiffGearSetRating':
        ...
        if _364.StraightBevelDiffGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_straight_bevel_gear_set_rating(self) -> '_368.StraightBevelGearSetRating':
        ...
        if _368.StraightBevelGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
