...
class Bearing(_2192.Connector):
    ...
    @property
    def inner_fitting_chart(self) -> '_1562.LegacyChartDefinition':
        ...
        return constructor.new(_1562.LegacyChartDefinition)(self.wrapped.InnerFittingChart) if self.wrapped.InnerFittingChart is not None else None

    @property
    def outer_fitting_chart(self) -> '_1562.LegacyChartDefinition':
        ...
        return constructor.new(_1562.LegacyChartDefinition)(self.wrapped.OuterFittingChart) if self.wrapped.OuterFittingChart is not None else None
