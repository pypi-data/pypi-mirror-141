...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5828, _5829
...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def modes_to_display(self) -> '_5828.ModalContributionDisplayMethod':
        ...
        return constructor.new(_5828.ModalContributionDisplayMethod)(value) if value is not None else None

    @modes_to_display.setter
    def modes_to_display(self, value: '_5828.ModalContributionDisplayMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ModesToDisplay = value

    @property
    def filtering_method(self) -> '_5829.ModalContributionFilteringMethod':
        ...
        return constructor.new(_5829.ModalContributionFilteringMethod)(value) if value is not None else None

    @filtering_method.setter
    def filtering_method(self, value: '_5829.ModalContributionFilteringMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
