...
class DynamicAnalysisViewable(_1997.PartAnalysisCaseWithContourViewable):
    ...
    @property
    def contour_draw_style_of_type_steady_state_synchronous_response_draw_style(self) -> '_3346.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3346.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_modal_analysis_draw_style(self) -> '_4903.ModalAnalysisDrawStyle':
        ...
        if _4903.ModalAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5746.HarmonicAnalysisDrawStyle':
        ...
        if _5746.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style_of_type_modal_analysis_draw_style(self) -> '_4903.ModalAnalysisDrawStyle':
        ...
        if _4903.ModalAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5746.HarmonicAnalysisDrawStyle':
        ...
        if _5746.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
