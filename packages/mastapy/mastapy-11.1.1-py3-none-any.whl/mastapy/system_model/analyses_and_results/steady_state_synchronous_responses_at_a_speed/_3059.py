...
class PartSteadyStateSynchronousResponseAtASpeed(_7268.PartStaticLoadAnalysisCase):
    ...
    @property
    def steady_state_synchronous_response_at_a_speed(self) -> '_3085.SteadyStateSynchronousResponseAtASpeed':
        ...
        return constructor.new(_3085.SteadyStateSynchronousResponseAtASpeed)(self.wrapped.SteadyStateSynchronousResponseAtASpeed) if self.wrapped.SteadyStateSynchronousResponseAtASpeed is not None else None
