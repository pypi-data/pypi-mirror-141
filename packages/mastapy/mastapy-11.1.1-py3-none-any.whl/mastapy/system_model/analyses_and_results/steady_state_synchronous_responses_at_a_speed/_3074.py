...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3085, _2987
...
class RootAssemblySteadyStateSynchronousResponseAtASpeed(_2987.AssemblySteadyStateSynchronousResponseAtASpeed):
    '''RootAssemblySteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def steady_state_synchronous_response_at_a_speed_inputs(self) -> '_3085.SteadyStateSynchronousResponseAtASpeed':
        ...
        return constructor.new(_3085.SteadyStateSynchronousResponseAtASpeed)(self.wrapped.SteadyStateSynchronousResponseAtASpeedInputs) if self.wrapped.SteadyStateSynchronousResponseAtASpeedInputs is not None else None
