...
class PartCompoundHarmonicAnalysisOfSingleExcitation(_7266.PartCompoundAnalysis):
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5486.PartHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5486.PartHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5486.PartHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5486.PartHarmonicAnalysisOfSingleExcitation))
        return value
