...
class BeltDriveCompoundHarmonicAnalysisOfSingleExcitation(_5634.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    '''BeltDriveCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5416.BeltDriveHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5416.BeltDriveHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5416.BeltDriveHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5416.BeltDriveHarmonicAnalysisOfSingleExcitation))
        return value
