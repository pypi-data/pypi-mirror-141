...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed(_4718.CoaxialConnectionCompoundModalAnalysisAtASpeed):
    '''CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4609.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4609.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4609.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4609.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed))
        return value
