...
class OilSealCompoundModalAnalysisAtASpeed(_4730.ConnectorCompoundModalAnalysisAtASpeed):
    '''OilSealCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4643.OilSealModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4643.OilSealModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4643.OilSealModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4643.OilSealModalAnalysisAtASpeed))
        return value
