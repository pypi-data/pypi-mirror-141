...
class BevelGearSetCompoundModalAnalysisAtASpeed(_4700.AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed):
    '''BevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4583.BevelGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4583.BevelGearSetModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4583.BevelGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4583.BevelGearSetModalAnalysisAtASpeed))
        return value
