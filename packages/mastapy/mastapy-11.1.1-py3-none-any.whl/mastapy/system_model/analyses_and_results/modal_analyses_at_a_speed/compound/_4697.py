...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed(_4729.ConnectionCompoundModalAnalysisAtASpeed):
    '''AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4568.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4568.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4568.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4568.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed))
        return value
