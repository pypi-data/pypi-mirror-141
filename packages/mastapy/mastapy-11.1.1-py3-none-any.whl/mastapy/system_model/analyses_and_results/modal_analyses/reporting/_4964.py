...
class CalculateFullFEResultsForMode(_0.APIBase):
    ...
    @property
    def fe_results(self) -> 'List[_4968.ModalCMSResultsForModeAndFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEResults, constructor.new(_4968.ModalCMSResultsForModeAndFE))
        return value
