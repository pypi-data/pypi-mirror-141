...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4860, _4954, _4953, _4907,
    _4955
)
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import (
    _5823, _5826, _5831, _5832
)
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5749, _5737, _5791
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def coordinate_system(self) -> '_4860.CoordinateSystemForWhine':
        ...
        return constructor.new(_4860.CoordinateSystemForWhine)(value) if value is not None else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4860.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def connected_component_type(self) -> '_5823.ConnectedComponentType':
        ...
        return constructor.new(_5823.ConnectedComponentType)(value) if value is not None else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5823.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def whine_waterfall_export_option(self) -> '_4954.WhineWaterfallExportOption':
        ...
        return constructor.new(_4954.WhineWaterfallExportOption)(value) if value is not None else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4954.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5826.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5826.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations is not None else None

    @property
    def waterfall_chart_settings(self) -> '_4953.WaterfallChartSettings':
        ...
        return constructor.new(_4953.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings is not None else None

    @property
    def order_cuts_chart_settings(self) -> '_4907.OrderCutsChartSettings':
        ...
        return constructor.new(_4907.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings is not None else None
    ...
    @property
    def frequency_options(self) -> '_5737.FrequencyOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5737.FrequencyOptionsForHarmonicAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions is not None else None

    @property
    def reference_speed_options(self) -> '_5791.SpeedOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5791.SpeedOptionsForHarmonicAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions is not None else None

    @property
    def very_short_length_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1458.LengthVeryShort]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1458.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues is not None else None

    @property
    def small_angle_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1411.AngleSmall]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1411.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues is not None else None

    @property
    def small_velocity_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1510.VelocitySmall]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1510.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues is not None else None

    @property
    def angular_velocity_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1417.AngularVelocity]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1417.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues is not None else None

    @property
    def acceleration_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1408.Acceleration]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1408.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues is not None else None

    @property
    def angular_acceleration_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1413.AngularAcceleration]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1413.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues is not None else None

    @property
    def force_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1432.Force]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1432.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues is not None else None

    @property
    def torque_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1505.Torque]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1505.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues is not None else None

    @property
    def energy_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1426.Energy]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1426.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues is not None else None

    @property
    def power_small_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1476.PowerSmall]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1476.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues is not None else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1477.PowerSmallPerArea]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1477.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues is not None else None

    @property
    def pressure_reference_values(self) -> '_4955.WhineWaterfallReferenceValues[_1480.Pressure]':
        ...
        return constructor.new(_4955.WhineWaterfallReferenceValues)[_1480.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues is not None else None

    @property
    def result_location_selection_groups(self) -> '_5831.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5831.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups is not None else None

    @property
    def active_result_locations(self) -> 'List[_5832.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5832.ResultNodeSelection))
        return value
