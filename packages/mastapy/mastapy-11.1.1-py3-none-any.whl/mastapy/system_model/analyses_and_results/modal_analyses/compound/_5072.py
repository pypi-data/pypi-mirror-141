...
class ShaftHubConnectionCompoundModalAnalysis(_5012.ConnectorCompoundModalAnalysis):
    '''ShaftHubConnectionCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4924.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4924.ShaftHubConnectionModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4924.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4924.ShaftHubConnectionModalAnalysis))
        return value
