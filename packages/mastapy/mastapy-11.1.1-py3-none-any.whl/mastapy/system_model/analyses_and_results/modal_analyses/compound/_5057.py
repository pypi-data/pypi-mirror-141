...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5014
...
class PartToPartShearCouplingConnectionCompoundModalAnalysis(_5014.CouplingConnectionCompoundModalAnalysis):
    '''PartToPartShearCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4909.PartToPartShearCouplingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4909.PartToPartShearCouplingConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4909.PartToPartShearCouplingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4909.PartToPartShearCouplingConnectionModalAnalysis))
        return value
