...
class BevelDifferentialPlanetGearCompoundModalAnalysis(_4987.BevelDifferentialGearCompoundModalAnalysis):
    '''BevelDifferentialPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4837.BevelDifferentialPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4837.BevelDifferentialPlanetGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4837.BevelDifferentialPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4837.BevelDifferentialPlanetGearModalAnalysis))
        return value
