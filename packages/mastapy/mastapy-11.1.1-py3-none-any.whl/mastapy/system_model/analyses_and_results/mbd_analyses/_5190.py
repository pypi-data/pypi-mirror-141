...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def frequency_response_options(self) -> '_4882.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4882.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions is not None else None
