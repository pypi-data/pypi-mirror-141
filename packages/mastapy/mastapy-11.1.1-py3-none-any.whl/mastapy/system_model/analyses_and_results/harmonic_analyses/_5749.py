...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5826
from mastapy.system_model.analyses_and_results.modal_analyses import _4904
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5791, _5737
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5826.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5826.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection is not None else None

    @property
    def modal_analysis_options(self) -> '_4904.ModalAnalysisOptions':
        ...
        return constructor.new(_4904.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions is not None else None
