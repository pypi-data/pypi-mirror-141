...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5843, _5850
...
class ResultsForOrderIncludingSurfaces(_5850.ResultsForOrderIncludingNodes):
    '''ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5843.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESurfaces, constructor.new(_5843.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic))
        return value
