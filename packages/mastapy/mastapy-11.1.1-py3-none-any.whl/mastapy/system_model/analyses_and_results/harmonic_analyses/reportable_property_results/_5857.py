...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5850, _5833
...
class SingleWhineAnalysisResultsPropertyAccessor(_5833.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5850.ResultsForOrderIncludingNodes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5850.ResultsForOrderIncludingNodes))
        return value
