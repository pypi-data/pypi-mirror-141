...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5854, _5834
...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    @property
    def magnitude(self) -> '_5854.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic':
        ...
        return constructor.new(_5854.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic)(self.wrapped.Magnitude) if self.wrapped.Magnitude is not None else None

    @property
    def result_at_reference_speed(self) -> '_5834.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic':
        ...
        return constructor.new(_5834.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic)(self.wrapped.ResultAtReferenceSpeed) if self.wrapped.ResultAtReferenceSpeed is not None else None

    @property
    def data_points(self) -> 'List[_5834.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DataPoints, constructor.new(_5834.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic))
        return value
