...
from mastapy.system_model.analyses_and_results.harmonic_analyses import (
    _5750, _2375, _2376, _5673
)
from mastapy._internal import constructor
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5855
...
class RootAssemblyHarmonicAnalysis(_5673.AssemblyHarmonicAnalysis):
    '''RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self) -> '_5750.HarmonicAnalysisRootAssemblyExportOptions':
        ...
        return constructor.new(_5750.HarmonicAnalysisRootAssemblyExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None

    @property
    def results(self) -> '_5855.RootAssemblyHarmonicAnalysisResultsPropertyAccessor':
        ...
        return constructor.new(_5855.RootAssemblyHarmonicAnalysisResultsPropertyAccessor)(self.wrapped.Results) if self.wrapped.Results is not None else None
