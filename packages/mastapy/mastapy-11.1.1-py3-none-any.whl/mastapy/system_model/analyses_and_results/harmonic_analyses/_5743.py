...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5738, _5740, _5790
...
class GearSetHarmonicAnalysis(_5790.SpecialisedAssemblyHarmonicAnalysis):
    '''GearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5738.GearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsHarmonicAnalysis, constructor.new(_5738.GearHarmonicAnalysis))
        return value

    @property
    def meshes_harmonic_analysis(self) -> 'List[_5740.GearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesHarmonicAnalysis, constructor.new(_5740.GearMeshHarmonicAnalysis))
        return value
