...
class InterMountableComponentConnectionCompoundHarmonicAnalysis(_5893.ConnectionCompoundHarmonicAnalysis):
    '''InterMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5755.InterMountableComponentConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5755.InterMountableComponentConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5755.InterMountableComponentConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5755.InterMountableComponentConnectionHarmonicAnalysis))
        return value
