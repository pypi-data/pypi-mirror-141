...
class CycloidalDiscCompoundHarmonicAnalysis(_5859.AbstractShaftCompoundHarmonicAnalysis):
    '''CycloidalDiscCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5712.CycloidalDiscHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5712.CycloidalDiscHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5712.CycloidalDiscHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5712.CycloidalDiscHarmonicAnalysis))
        return value
