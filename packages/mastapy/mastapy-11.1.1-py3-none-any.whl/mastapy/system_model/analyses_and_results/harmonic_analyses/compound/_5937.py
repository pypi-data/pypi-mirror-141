...
class PartCompoundHarmonicAnalysis(_7266.PartCompoundAnalysis):
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5769.PartHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5769.PartHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5769.PartHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5769.PartHarmonicAnalysis))
        return value
