...
class StraightBevelDiffGearMeshPowerFlow(_3784.BevelGearMeshPowerFlow):
    ...
    @property
    def rating(self) -> '_362.StraightBevelDiffGearMeshRating':
        ...
        return constructor.new(_362.StraightBevelDiffGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None

    @property
    def component_detailed_analysis(self) -> '_362.StraightBevelDiffGearMeshRating':
        ...
        return constructor.new(_362.StraightBevelDiffGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
