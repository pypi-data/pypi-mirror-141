...
class SteadyStateSynchronousResponse(_7257.CompoundAnalysisCase):
    ...
    @property
    def steady_state_analysis_options(self) -> '_3347.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3347.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions is not None else None
