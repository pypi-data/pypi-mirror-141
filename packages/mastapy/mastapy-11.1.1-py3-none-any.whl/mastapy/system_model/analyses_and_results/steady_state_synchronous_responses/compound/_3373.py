...
class AbstractShaftCompoundSteadyStateSynchronousResponse(_3374.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse):
    '''AbstractShaftCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3241.AbstractShaftSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3241.AbstractShaftSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3241.AbstractShaftSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3241.AbstractShaftSteadyStateSynchronousResponse))
        return value
