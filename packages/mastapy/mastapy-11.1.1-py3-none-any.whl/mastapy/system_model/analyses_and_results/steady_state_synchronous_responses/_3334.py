...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3345, _3246
...
class RootAssemblySteadyStateSynchronousResponse(_3246.AssemblySteadyStateSynchronousResponse):
    '''RootAssemblySteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response_inputs(self) -> '_3345.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3345.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponseInputs) if self.wrapped.SteadyStateSynchronousResponseInputs is not None else None
