...
class CVTBeltConnectionCompoundModalAnalysisAtAStiffness(_4445.BeltConnectionCompoundModalAnalysisAtAStiffness):
    '''CVTBeltConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4346.CVTBeltConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4346.CVTBeltConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4346.CVTBeltConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4346.CVTBeltConnectionModalAnalysisAtAStiffness))
        return value
