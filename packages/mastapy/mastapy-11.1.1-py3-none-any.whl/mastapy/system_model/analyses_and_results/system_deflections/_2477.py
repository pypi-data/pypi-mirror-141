...
class CylindricalGearMeshSystemDeflection(_2497.GearMeshSystemDeflection):
    ...
    @property
    def chart_of_misalignment_in_transverse_line_of_action(self) -> '_1562.LegacyChartDefinition':
        ...
        return constructor.new(_1562.LegacyChartDefinition)(self.wrapped.ChartOfMisalignmentInTransverseLineOfAction) if self.wrapped.ChartOfMisalignmentInTransverseLineOfAction is not None else None
