...
from mastapy.utility.report import _1546, _1549
...
TItem = TypeVar('TItem', bound='_1549.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1546.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
