...
from mastapy.utility.report import _1561, _1554
...
class UserTextRow(_1554.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1561.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1561.HeadingSize)(value) if value is not None else None

    @heading_size.setter
    def heading_size(self, value: '_1561.HeadingSize'):
