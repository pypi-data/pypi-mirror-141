...
class ConfigurationClient(BaseClient):
    ...
    def get(self, configuration_id: str, resource_group: str = None) -> Configuration:
        ...
        """
        configuration_dict = self.rest_client.get(path=f'/configurations/{configuration_id}',
    ...
    def query(self, scenario_id: str = None, executable_ids: List[str] = None, top: int = None, skip: int = None,
              search: str = None, resource_group: str = None) -> ConfigurationQueryResponse:
