...
class ArtifactClient(BaseClient):
    ...
    def get(self, artifact_id: str, resource_group: str = None) -> Artifact:
        ...
        """
        artifact_dict = self.rest_client.get(path=f'/artifacts/{artifact_id}', resource_group=resource_group)
