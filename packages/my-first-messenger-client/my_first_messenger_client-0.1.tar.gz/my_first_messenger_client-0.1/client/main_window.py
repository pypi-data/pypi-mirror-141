...
sys.path.append('../../')
from client_dist.client.main_window_conv import Ui_MainClientWindow
from client_dist.client.add_contact import AddContactDialog
from client_dist.client.del_contact import DelContactDialog
