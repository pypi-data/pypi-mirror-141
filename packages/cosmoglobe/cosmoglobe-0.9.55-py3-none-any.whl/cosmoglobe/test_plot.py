...
if False: #simplest
    plot(path+dust, width="m", sig="Q",comp="dust",norm="log")
    plt.show()
...
def main(
    ...
    blm = data["27S/beam/T"][...]
    blmax = data["27S/beamlmax"][...]
    bmmax = data["27S/beammmax"][...]

    slm = data["27S/sl/T"][...]
    slmax = data["27S/sllmax"][...]
    smmax = data["27S/slmmax"][...]
    ...
    plot(m + m1, rot=(0, 90, 0), min=1e-5, max=5e-2,norm="log", cmap="afmhot",width="l")

    #print(m.shape, m1.shape)
    plt.show()

main(nside_planck=2048)
