...
class IDACController:
    ...
    def __init__(
        ...
        if self.auth_type == IDACAuthType.BASIC and isinstance(auth, list):
    ...
    async def get_auth_token(self, creds: str, datacenter: str, use_as_auth: bool = True) -> str:
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code == 404:
                ...
                logger.debug("Looks like controller doesn't support dCloud session auth. Ignoring")
                if use_as_auth:
                    self.auth = "empty_token"
                return "empty_token"
