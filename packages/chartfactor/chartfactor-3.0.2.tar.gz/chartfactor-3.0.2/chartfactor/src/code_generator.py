                ...
                for k in options:
                    ...
                    if k == 'legend':
                        if isinstance(o, Legend):
                            ...
                            l_width = o.get_width
                            l_height = o.get_height if not isinstance(o.get_height, dict) else o.get_height.get('value', '95%')
                            l_height += '' if not isinstance(o.get_height, dict) else o.get_height.get('unit', '')
                            l_height = l_height if re.match(r"/[0-9]/", l_height) else f'{l_height}'
                            l_sort = o.get_sort
