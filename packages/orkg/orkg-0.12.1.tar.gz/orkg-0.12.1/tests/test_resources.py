...
class TestResources(TestCase):
    ...
    def test_update_obs(self):
        ...
        self.assertTrue(res.succeeded)
        label = "test"
        res = self.orkg.resources.update_observatory(id=res.content['id'], observatory_id='11111111-1111-1111-1111-111111111111', organization_id='11111111-1111-1111-1111-111111111111')
        self.assertTrue(res.succeeded)
