...
class RequestClient(object):
    ...
    def post_order(self, symbol: 'str', side: 'OrderSide', ordertype: 'OrderType', 
                ...
                activationPrice: 'float' = None, priceProtect: 'boolean' = None, newOrderRespType: 'OrderRespType' = OrderRespType.INVALID) -> any:
        """
        New Order (TRADE)
        ...
        Send in a new order.
        """
        response = call_sync(self.request_impl.post_order(symbol, side, ordertype, timeInForce, quantity, reduceOnly, price, newClientOrderId, stopPrice, 
                                workingType, closePosition, positionSide, callbackRate, activationPrice, priceProtect, newOrderRespType))
        self.refresh_limits(response[1])
        return response[0]
