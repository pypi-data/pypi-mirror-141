...
def train_qa(**kwargs):
    ...
    train_InputData_list = convert_to_inputdata_qa(tokenizer, train_data_list, maxlen = args.maxlen, mode = "train", disable=args.disable)
    eval_InputData_list = convert_to_inputdata_qa(tokenizer,eval_data_list, maxlen = args.maxlen, mode = "train",disable = args.disable)
