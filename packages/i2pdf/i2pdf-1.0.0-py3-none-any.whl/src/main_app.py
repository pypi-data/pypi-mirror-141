...
# Custom
from src.auxiliary.MessageKeys import MessageKeys as mk
from src.auxiliary.FileExplorer import FileExplorer
...
def add_metadata(
    ...
    example:
        python i2pdf.py metadata gen.pdf test.yaml
