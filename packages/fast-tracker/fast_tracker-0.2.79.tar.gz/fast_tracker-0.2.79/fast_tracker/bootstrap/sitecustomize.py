...
startup_debug = os.environ.get("FastTracker.Debug", "off").lower() in ("on", "true", "1")
fast_debug_level = int(os.environ.get("FastTracker.Debug.Level", "0"))
...
log_message("fast_debug_level:%d", fast_debug_level)
