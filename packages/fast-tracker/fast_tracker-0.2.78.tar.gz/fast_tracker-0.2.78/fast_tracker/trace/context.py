...
class SpanContext(object):
    ...
    def new_local_span(self, op: str) -> Span:
        ...
        # functions.log("local span is: %r", span)
        return span
    ...
    def new_entry_span(self, op: str, carrier: "Carrier" = None) -> Span:
        ...
        functions.log("span_id:%s,parent_id:%s,pid:%s",carrier.span_id,parent_id,span.pid)
        # functions.log("entry span is: %r", span)
        return span
    ...
    def new_exit_span(self, op: str, peer: str) -> Span:
        ...
        # functions.log("exit span is: %r", span)
        return span
