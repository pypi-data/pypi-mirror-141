...
@LastEditTime: 2022-03-08 14:30:10
...
class SevenBaseHandler(BaseApiHandler):
    ...
    def reponse_custom(self, rep_dic):
        ...
        :last_editors: HuangJingCan
        """
        return self.http_response_1(self.json_dumps(rep_dic))

    def http_response_1(self, content, log_extra_dict=None):
        """
    ...
    def reponse_common(self, success=True, data=None, error_code="", error_message=""):
        ...
        return self.http_response_1(self.json_dumps(rep_dic), log_extra_dict)
