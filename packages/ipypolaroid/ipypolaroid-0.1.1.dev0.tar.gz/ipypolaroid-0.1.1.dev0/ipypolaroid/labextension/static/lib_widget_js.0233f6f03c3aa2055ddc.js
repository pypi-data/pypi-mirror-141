...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PolaroidView = exports.PolaroidModel = exports.litPolaroid = void 0;
...
class litPolaroid extends lit_element_1.LitElement {
    ...
    static get styles() {
        return style_1.polaroid_styles;
    }
    get caption_element() {
    ...
    _handleDoubleClick(e) {
        ...
        const img = modal.querySelector('.image_zoom');
    ...
    render() {
        ...
        //${image_height}px
        return lit_element_1.html `
		<div class="polaroid tooltip" style="width:${this.width}px;"  @click="${(e) => this._handleClick(e)}"  @dblclick="${(e) => this._handleDoubleClick(e)}" target="${this.target}" >
...
exports.litPolaroid = litPolaroid;
...
exports.polaroid_styles = lit_element_1.css `
  ...
  `;
exports.carousel_styles = lit_element_1.css `
	  .lit-carousel{
		display: flex;
		flex-direction: row;
		overflow: hidden;
	  ...
	  .lit-carousel:focus { outline: none; }
	.icon {
		 width:  30px;
		 height:  30px;
...
exports.fastforward = lit_element_1.html `<svg   version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
	  ...
	  <path d="M271.085,240.915L164.418,134.248c-8.331-8.331-21.839-8.331-30.17,0s-8.331,21.839,0,30.17L225.83,256l-91.582,91.582
		...
		C279.416,262.754,279.416,249.246,271.085,240.915z"/></svg>`;
//@ts-ignore
exports.left_arrow = lit_element_1.html `<svg  version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
	  <path d="M256,0C114.618,0,0,114.618,0,256s114.618,256,256,256s256-114.618,256-256S397.382,0,256,0z M256,469.333
		c-117.818,0-213.333-95.515-213.333-213.333S138.182,42.667,256,42.667S469.333,138.182,469.333,256S373.818,469.333,256,469.333z"/>
	  <path d="M309.416,152.144l-149.333,85.333c-14.332,8.19-14.332,28.855,0,37.045l149.333,85.333
		...
		L213.665,256l85.001-48.572V304.572z"/></svg>`;
//@ts-ignore
exports.right_arrow = lit_element_1.html `<svg  version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
	  <path d="M256,0C114.618,0,0,114.618,0,256s114.618,256,256,256s256-114.618,256-256S397.382,0,256,0z M256,469.333
		c-117.818,0-213.333-95.515-213.333-213.333S138.182,42.667,256,42.667S469.333,138.182,469.333,256S373.818,469.333,256,469.333z"/>
	  <path d="M351.918,237.477l-149.333-85.333c-14.222-8.127-31.918,2.142-31.918,18.523v170.667
		...
		L298.335,256L213.333,304.572z"/> </svg>`;
//@ts-ignore
exports.rewind = lit_element_1.html `<svg  version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	  viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
	  <path d="M256,0C114.618,0,0,114.618,0,256s114.618,256,256,256s256-114.618,256-256S397.382,0,256,0z M256,469.333
	  ...
	  <path d="M377.752,134.248c-8.331-8.331-21.839-8.331-30.17,0L240.915,240.915c-8.331,8.331-8.331,21.839,0,30.17l106.667,106.667
		...
		C386.083,156.087,386.083,142.58,377.752,134.248z"/></svg>`;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CarouselView = exports.CarouselModel = void 0;
// Copyright (c) nicolas allezard
// Distributed under the terms of the Modified BSD License.
//@ts-ignore
const base_1 = __webpack_require__(/*! @jupyter-widgets/base */ "webpack/sharing/consume/default/@jupyter-widgets/base");
...
const style_1 = __webpack_require__(/*! ./style */ "./lib/style.js");
const polaroid_1 = __webpack_require__(/*! ./polaroid */ "./lib/polaroid.js");
class litCarousel extends lit_element_1.LitElement {
    constructor() {
        super();
        this.keyHandlerBindDown = this.onKeyDown.bind(this);
        this.keyHandlerBindUp = this.onKeyUp.bind(this);
    ...
    static get styles() {
        return style_1.carousel_styles;
    }
    deselect() {
    ...
    createItems(image_list) {
        ...
        for (var i = 0; i < this.polaroid_items.length; ++i) {
            this.polaroid_items[i] = new polaroid_1.litPolaroid();
        ...
        for (var i = begin; i < end; ++i, ++i_item) {
            if (this.images_data.has(i)) {
                if (!this.polaroid_items[i_item])
                    this.polaroid_items[i_item] = new polaroid_1.litPolaroid();
    ...
    updateItem(i) {
        const match = this.polaroid_items.filter((item) => item.id === i.toString());
        if (match.length > 0) {
    ...
    render() {
        ...
        return lit_element_1.html `
			...
			<div class="navigation"  style="width:${this.width}px; " >
				...
				<p class="icon" title="Rewind"         @click=${() => this.move_by(-10)} >${style_1.rewind}</p>
			  	<p class="icon" title="Back"           @click=${() => this.move_by(-1)} >${style_1.left_arrow}</p>
			  	<p class="icon" title="Next"           @click=${() => this.move_by(1)} >${style_1.right_arrow}</p>
			  	<p class="icon" title="Fast Forward"   @click=${() => this.move_by(10)} >${style_1.fastforward}</p>
			</div>
			`;
    }
    wheel_func(event) {
...
class CarouselModel extends base_1.DOMWidgetModel {
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: CarouselModel.model_name, _model_module: CarouselModel.model_module, _model_module_version: CarouselModel.model_module_version, _view_name: CarouselModel.view_name, _view_module: CarouselModel.view_module, _view_module_version: CarouselModel.view_module_version, _id: 'Carousel', image_list: [], image_index: [], im_format: 'png', image_captions: [], width: "100%", item_with: 200, item_height: 200, selected_id: [], n: 10 });
    }
    initialize(attributes, options) {
        super.initialize(attributes, options);
        console.log("initialize");
