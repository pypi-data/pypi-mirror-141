...
exports.polaroid_styles = lit_element_1.css `
  ...
  `;
exports.carouselstyles = lit_element_1.css `
	  .lit-carousel{
		display: flex;
		flex-direction: row;
		overflow: hidden;
...
//# sourceMappingURL=lib_widget_js.f50a3e11aa75c2fca70a.js.map