...
class litCarousel extends lit_element_1.LitElement {
    ...
    // 		console.log("firstUpdated",modal)
...
<div id="myModal" class="modal">
  ...
  <!-- Modal content -->
  	<div class="modal-content">
    	<span class="close" @click=${() => this.closeModal()}>  &times style="padding:5px"; </span>
...
//# sourceMappingURL=lib_widget_js.a6a044ce1db6397bc814.js.map