...
# -*- coding: utf-8 -*-
#
# ipypolaroid documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipypolaroid', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipypolaroiddoc'
...
latex_documents = [
    (master_doc, 'ipypolaroid.tex', 'ipypolaroid Documentation',
