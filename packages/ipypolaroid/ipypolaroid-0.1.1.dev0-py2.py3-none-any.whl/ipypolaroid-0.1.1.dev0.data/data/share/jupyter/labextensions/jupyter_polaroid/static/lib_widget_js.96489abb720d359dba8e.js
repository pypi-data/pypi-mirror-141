...
class litPolaroid extends lit_element_1.LitElement {
    ...
    render() {
		...
		<div id="myModal" class="modal">
			...
			<img class="image_zoom" style="height:${this.zoomHeight}; object-fit:contain; ">
	  			</div>
    ...
    render() {
        ...
        return lit_element_1.html `
			...
			<div class="lit-carousel" id="polaroidCarousel" tabIndex="1"
				 style="width:${width};; height:fit-content; flex-wrap:${this.wrap_mode}" 
...
//# sourceMappingURL=lib_widget_js.96489abb720d359dba8e.js.map