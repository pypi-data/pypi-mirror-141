...
class litPolaroid extends lit_element_1.LitElement {
    ...
    _handleClick(e) {
        ...
        if (this.carousel.zoomMode) {
            var modal = this.carousel.shadowRoot.getElementById("myModal");
            console.log(this.carousel.getBoundingClientRect());
            ...
            const i = modal.querySelector('.image_zoom');
...
class litCarousel extends lit_element_1.LitElement {
    ...
    render() {
        ...
        return lit_element_1.html `
			...
			<div class="lit-carousel" id="polaroidCarousel" tab-index=1
...
//# sourceMappingURL=lib_widget_js.43679154dcf6097ed6e7.js.map