...
def calculateDelta(problem_labels, weight, fuzzyNumbers_ulowa, labels_ulowa):
    ...
    """
    xsi = defuzzifyCOG(fuzzyNumbers_ulowa, labels_ulowa, labels_ulowa[len(problem_labels) - 1])
    xsj = defuzzifyCOG(fuzzyNumbers_ulowa, labels_ulowa, labels_ulowa[len(problem_labels) - 2])
