...
def calculateDelta(problem_labels, weight, fuzzyNumbers_ulowa, labels_ulowa):
    ...
    """
    xsi = defuzzifyCOG(fuzzyNumbers_ulowa, labels_ulowa, labels_ulowa.index(problem_labels[len(problem_labels) - 1]))
    xsj = defuzzifyCOG(fuzzyNumbers_ulowa, labels_ulowa, labels_ulowa.index(problem_labels[len(problem_labels) - 1]))
...
print(f"The center of gravity of the fuzzy set is: {defuzzifyCOG(fuzzyNumbers, labels, 'VL' )}")
print(f"The center of maximum of the fuzzy set is: {defuzzifyCOM(fuzzyNumbers, labels, 'VL' )}")

# Those will give us the COG and COM of the first fuzzy number



tag = "VL"  # example of the tag we want to get the ordinal number from
