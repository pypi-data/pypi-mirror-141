...
OWAweights = [0.0, 0.0, 0.5, 0.5, 0.0]

alternatives = ["Caleta", "Tarakon", "Dominos", "Ancora", "Frida", "Cucafera"]
criteria = ["Food", "Service", "Atmosphere", "Category", "Location"]

performance_table = [["VL", "VL", "P", "H", "VL"], ["VL", "VL", "H", "P", "P"], ["VL", "VL", "L", "M", "L"],
                     ["VH", "L", "H", "H", "AH"], ["P", "L", "H", "L", "AH"], ["P", "VL", "VL", "M", "AH"]]
results1 = []
for alt in performance_table:
    results1.append(ulowaOperation(alt, OWAweights, fuzzySets, labels))
print(results1)
