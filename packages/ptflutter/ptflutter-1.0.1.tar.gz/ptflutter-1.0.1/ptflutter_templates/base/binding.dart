...
import 'package:{{ package_name }}/presentation/{{ name_lower }}/{{ name_lower }}_navigator.dart';
import 'package:{{ package_name }}/presentation/{{ name_lower }}/{{ name_lower }}_usecase.dart';
import 'package:{{ package_name }}/mock/{{ name_lower }}_usecase_mock.dart';
import 'package:{{ package_name }}/presentation/{{ name_lower }}/{{ name_lower }}_viewmodel.dart';
