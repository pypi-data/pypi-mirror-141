        ...
        def _register_navigator(self):
            ...
            try:
                ...
                with open(path, 'r+', encoding='utf8') as f :
                    ...
                    import_1 = "\nimport 'package:%s/presentation/%s/%s_binding.dart';" %(package_name, name, name)
                ...
                exit(1)
            try:
                path = './lib/presentation/base/base_navigator.dart'
