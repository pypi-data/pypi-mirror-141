...
from ptflutter.utils.dart_helpers import format_dart_file_code
    ...
    class BaseTemplate(object):
        def __init__(self, options, name, package_name):
            ...
            self.env = Environment(
                loader=PackageLoader('ptflutter_templates', 'base_mobx'),
                trim_blocks=True,
                lstrip_blocks=True
            )
