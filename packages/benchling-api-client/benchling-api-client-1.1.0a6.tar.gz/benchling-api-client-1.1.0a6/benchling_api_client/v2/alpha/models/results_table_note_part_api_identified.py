...
T = TypeVar("T", bound="ResultsTableNotePartApiIdentified")


@attr.s(auto_attribs=True, repr=False)
class ResultsTableNotePartApiIdentified:
    """  """
    ...
    def __repr__(self):
        ...
        return "ResultsTableNotePartApiIdentified({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        results_table_note_part_api_identified = cls(
            api_id=api_id,
            columns=columns,
        ...
        results_table_note_part_api_identified.additional_properties = d
        return results_table_note_part_api_identified
