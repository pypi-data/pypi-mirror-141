...
T = TypeVar("T", bound="RegistryBulkUpsertOligo")


@attr.s(auto_attribs=True, repr=False)
class RegistryBulkUpsertOligo:
    """  """
    ...
    def __repr__(self):
        ...
        return "RegistryBulkUpsertOligo({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        registry_bulk_upsert_oligo = cls(
            name=name,
            schema_id=schema_id,
        ...
        registry_bulk_upsert_oligo.additional_properties = d
        return registry_bulk_upsert_oligo
