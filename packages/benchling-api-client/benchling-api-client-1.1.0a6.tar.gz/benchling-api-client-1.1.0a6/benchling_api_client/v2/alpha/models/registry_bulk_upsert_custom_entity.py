...
T = TypeVar("T", bound="RegistryBulkUpsertCustomEntity")


@attr.s(auto_attribs=True, repr=False)
class RegistryBulkUpsertCustomEntity:
    """  """
    ...
    def __repr__(self):
        ...
        return "RegistryBulkUpsertCustomEntity({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        registry_bulk_upsert_custom_entity = cls(
            name=name,
            schema_id=schema_id,
        ...
        registry_bulk_upsert_custom_entity.additional_properties = d
        return registry_bulk_upsert_custom_entity
