...
T = TypeVar("T", bound="MixturePrepTableNotePartApiIdentified")


@attr.s(auto_attribs=True, repr=False)
class MixturePrepTableNotePartApiIdentified:
    """  """
    ...
    def __repr__(self):
        ...
        return "MixturePrepTableNotePartApiIdentified({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        mixture_prep_table_note_part_api_identified = cls(
            api_id=api_id,
            columns=columns,
        ...
        mixture_prep_table_note_part_api_identified.additional_properties = d
        return mixture_prep_table_note_part_api_identified
