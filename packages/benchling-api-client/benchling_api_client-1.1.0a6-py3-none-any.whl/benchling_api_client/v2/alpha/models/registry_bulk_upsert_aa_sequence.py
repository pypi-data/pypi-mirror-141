...
T = TypeVar("T", bound="RegistryBulkUpsertAaSequence")


@attr.s(auto_attribs=True, repr=False)
class RegistryBulkUpsertAaSequence:
    """  """
    ...
    def __repr__(self):
        ...
        return "RegistryBulkUpsertAaSequence({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        registry_bulk_upsert_aa_sequence = cls(
            name=name,
            schema_id=schema_id,
        ...
        registry_bulk_upsert_aa_sequence.additional_properties = d
        return registry_bulk_upsert_aa_sequence
