...
T = TypeVar("T", bound="RegistrationTableNotePartApiIdentified")


@attr.s(auto_attribs=True, repr=False)
class RegistrationTableNotePartApiIdentified:
    """  """
    ...
    def __repr__(self):
        ...
        return "RegistrationTableNotePartApiIdentified({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        registration_table_note_part_api_identified = cls(
            api_id=api_id,
            columns=columns,
        ...
        registration_table_note_part_api_identified.additional_properties = d
        return registration_table_note_part_api_identified
