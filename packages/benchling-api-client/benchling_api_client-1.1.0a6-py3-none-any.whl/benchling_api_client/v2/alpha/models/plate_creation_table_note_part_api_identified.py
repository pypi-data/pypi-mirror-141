...
T = TypeVar("T", bound="PlateCreationTableNotePartApiIdentified")


@attr.s(auto_attribs=True, repr=False)
class PlateCreationTableNotePartApiIdentified:
    """  """
    ...
    def __repr__(self):
        ...
        return "PlateCreationTableNotePartApiIdentified({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        plate_creation_table_note_part_api_identified = cls(
            api_id=api_id,
            columns=columns,
        ...
        plate_creation_table_note_part_api_identified.additional_properties = d
        return plate_creation_table_note_part_api_identified
