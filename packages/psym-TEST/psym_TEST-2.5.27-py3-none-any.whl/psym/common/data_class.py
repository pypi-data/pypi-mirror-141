...
from psym.graphql.input.resource_specification_relation_ship_list_input import ResourceSpecificationRelationShipListInput
from ..graphql.input.add_resource_specification_relation_ship_list_input import AddResourceSpecificationRelationShipListInput
...
class resourceTypeBaseType(NamedTuple):
    """
    :param name: Name
    :type name: str
    :param id: ID
...
class resourceTypeClass(NamedTuple):
    """
    :param name: Name
    :type name: str
    :param id: ID
...
class resourceSpecificationRelationshipList(NamedTuple):

    id: str
    nameList: List[ResourceSpecificationRelationShipListInput]
    resourceSpecification: Optional[str]

class ResourceSpecificationRelationshipItems(NamedTuple):
    """
    :param name: Name
    :type name: str
    :param id: ID
