...
from mcli.projects.project_info import get_current_project
from mcli.projects.project_modify import (configure_branch, configure_docker_image, configure_project_name,
                                          configure_repo)
from mcli.utils.utils_config import get_config_namespace
...
def get_default_project_config() -> ProjectConfig:
    default_username = get_config_namespace()
