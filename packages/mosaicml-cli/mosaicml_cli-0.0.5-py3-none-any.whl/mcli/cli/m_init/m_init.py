...
from mcli.projects.project_create import generate_new_project
from mcli.projects.project_info import get_current_project, get_projects_directory, get_projects_list
