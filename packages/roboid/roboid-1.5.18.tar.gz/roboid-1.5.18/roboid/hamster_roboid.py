...
class HamsterLinkRoboid(HamsterRoboid):
    def __init__(self, index):
        super(HamsterLinkRoboid, self).__init__(index)
    ...
    def _init(self, port_name=None):
        self._tag = "Hamster[{}]".format(self._index)
    ...
    def _release(self):
        super(HamsterLinkRoboid, self)._release()
    ...
    def _reset(self):
        super(HamsterLinkRoboid, self)._reset()
        self._clear_id_and_motoring()
