...
class Analysis:
    ...
    def run(self):
        ...
        start_print_cmd(qc_cmd)
        start_print_cmd(cluster_cmd)
...
def parse_analysis(parser):
    ...
    parser.add_argument(
        ...
        type='str',
        default='other',
        help='select species for cell annotation, only for human and mouse. If your species is human or mouse, you need to define this parameter, default is other, mean no annotation'
    )
    parser.add_argument(
        '--outdir',
