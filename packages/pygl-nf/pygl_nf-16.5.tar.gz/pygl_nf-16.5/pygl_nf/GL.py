...
def Get_GRPgraph_wersion():
    print(colorama.Fore.BLUE+'GRPgraph version (16.5)'+colorama.Fore.RESET)
# 1
class Vec2_:
...
class Text_:
    ...
    def SET_TEXT_BG(self,col=(0,0,0)):
...
class Sub_events:
    ...
    class Mouse_init:
        ...
        def GET_POS(self,PYGL_WINDOW='y'): 
            if PYGL_WINDOW=='y':
        ...
        def GET_PRESS_ON_PYGL_WINDOW(self,BUTTON="left"):
            if BUTTON!='left' and BUTTON!='right' :
                print(colorama.Fore.RED+'Error'+colorama.Fore.RESET)
                print(colorama.Fore.YELLOW+'None flag'+colorama.Fore.RESET)
                print(colorama.Fore.YELLOW+'''flags : left , right'''+colorama.Fore.RESET)
    ...
    class GL:
                                            ...
                                            class Ellips:
                                                def __init__(self,col=(),pos=[],size=[],sh=0,surf=0):
                                                    ...
                                                    self.sh = sh
                                                    self.surf = surf
                                                    el_up = [pos[0]+size[0]/2,pos[1]] ; self.up = el_up
                                                    el_down = [pos[0]+size[0]/2,pos[1]+size[1]] ; self.down = el_down
                                                    el_left = [pos[0],pos[1]+size[1]/2] ; self.left = el_left
                                                    el_right = [pos[0]+size[0],pos[1]+size[1]/2] ; self.right = el_right
