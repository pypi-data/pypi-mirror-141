...
def Get_GRPgraph_wersion():
    print(colorama.Fore.BLUE+'GRPgraph version (17.1)'+colorama.Fore.RESET)
...
class Display_init:
    ...
    def __init__(self,size=[600,400],caption='Program',flags=Nones,BG_COLOR='White'):
    ...
    def Get_Print_Widgets(self,index=None):
        if index is None:
            for i in range(len(self.widgets)):
                print(colorama.Fore.RED + f'[ {i} ] - ' + colorama.Fore.RESET,end='')
