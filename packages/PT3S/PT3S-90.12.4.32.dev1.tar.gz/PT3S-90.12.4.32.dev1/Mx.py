...
class Mx():
    ...
    Args:
        ...
        * StatTimeTminTmaxInVecsOnly (default: False):
    ...
    2004-09-22 08:30:15+00:00                                 b'TIME'                               3.2
    """
    def __init__(self,mx1File,NoH5Read=False,NoMxsRead=False,maxRecords=None,StatTimeTminTmaxInVecsOnly=False): 
                    ...
                    while True:   # while f.tell() != os.fstat(f.fileno()).st_size does NOT work with Zip's file objects ...    
                        ...
                        if mxsVecsH5StorePtr != None:                                                        
                                 ...
                                 # die angegebenen gelesenen "Zeiten" werden hier nach dfVecAggs verarbeitet 
                                     ...
                                     pass
                                     logger.debug("{:s}Kein H5-Dump: Info: {!s:s}  {!s:s}".format(logStr,cSNAPSHOTTYPE,time))
    ...
    def getVecAggsResultsForObjectType(self
        ...
        # df
            ...
            # cols == row Idx von dfVecAggs; use .columns.to_flat_index() to flatten the col Idx
