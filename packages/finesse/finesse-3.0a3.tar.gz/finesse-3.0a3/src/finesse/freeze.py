...
def canFreeze(cls):
    """
    A function to be used as a decorator for classes which should have
    the ability to be frozen and unfrozen.
...
class Freezable:
    """
    An object which can be frozen and unfrozen, it is frozen
    upon construction.
    """
