...
class PseudoLockCavity(Action):
    ...
    cavities, not coupled in any way.
    ...
    def __init__(self, cavity, *, mode=[0, 0], name="pseudo_lock_cavity"):
        super().__init__(name)
        self.cavity = cavity
        self.mode = mode
    ...
    def _do(self, state):
        ...
        if ws is None:
            ...
            ws["operator"] = Operator(cav.source, cav.source, via=cav.source.opposite)
