...
class TFclient():
    ...
    def get_daily(self,code,start_date=None,end_date=None,sample_size=None,timeout=200):
        """
        Parameters
        ----------
        code : str
        ...
        """   
        return self._get_tstable(code=code,att=['open','high','low','close','pct_chg','vol','amount'],start_date=start_date,end_date=end_date,sample_size=sample_size,timeout=timeout)
