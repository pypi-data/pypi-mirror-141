...
from dkist_processing_common.tasks import PublishCatalogMessages
...
end_to_end.add_node(task=PublishCatalogMessages, upstreams=TransferL1Data)
end_to_end.add_node(task=Teardown, upstreams=PublishCatalogMessages)
