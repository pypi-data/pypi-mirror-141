...
def app():
    ...
    builder = BinaryPayloadBuilder(byteorder=Endian.Big,
                                   wordorder=Endian.Big)
    # address=0, bytes=8
    builder.add_16bit_uint(0x1)
    builder.add_16bit_uint(0x2)
    builder.add_16bit_uint(0x3)
    builder.add_16bit_uint(0x4)
    # address=8, bytes=8
    builder.add_16bit_int(-0x1)
    builder.add_16bit_int(-0x2)
    builder.add_16bit_int(-0x3)
    builder.add_16bit_int(-0x4)
    # address=16, bytes=8
    builder.add_32bit_uint(0x12345678)
    builder.add_32bit_uint(0x12345678)
    # address=24, bytes=8
    builder.add_32bit_int(-0x12345678)
    builder.add_32bit_int(-0x12345678)
    # address=32, bytes=8
    builder.add_32bit_float(12.34)
    builder.add_32bit_float(-12.34)
    # address=40, bytes=8
    builder.add_64bit_uint(0x123456789ABCDEF)
    # address=48, bytes=8
    builder.add_64bit_int(-0x123456789ABCDEF)
    # address=56, bytes=16
    ...
    coil_block = ModbusSequentialDataBlock(1, coil_builder.to_registers())
    block = ModbusSequentialDataBlock(1, builder.to_registers())
    store = ModbusSlaveContext(di=coil_block, co=coil_block, hr=block, ir=block)
