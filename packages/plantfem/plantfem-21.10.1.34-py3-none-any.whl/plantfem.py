...
class plantfem:
    ...
    if int(ret) != 0:
        ...
        if ans == "y" or ans == "Y":
            # install
            os.system("git clone https://github.com/kazulagi/plantFEM_binary.git && cd plantFEM_binary && python3 install.py")
    ...
    def Exec(self,script):
        os.system("plantfem load "+str(script))
        os.system("plantfem build && ./server.out")    
