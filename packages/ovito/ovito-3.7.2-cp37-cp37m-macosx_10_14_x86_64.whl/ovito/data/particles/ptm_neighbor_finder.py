...
class PTMNeighborFinder(ovito.plugins.ParticlesPython.PTMNeighborFinder):
    ...
    def find(self, index):
        ...
        query = ovito.plugins.ParticlesPython.PTMNeighborFinder.Query(self)
        query.find_neighbors(int(index), None)
