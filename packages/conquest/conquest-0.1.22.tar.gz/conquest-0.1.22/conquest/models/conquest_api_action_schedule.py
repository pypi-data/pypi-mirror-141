...
class ConquestApiActionSchedule(object):
    ...
    def __init__(self, action_date=None, action_id=None, cycles=None, duration=None, original_action_date=None, repeat_cycle_units=None, schedule_type=None, _configuration=None):  # noqa: E501
