...
class ConquestApiActionAssignment(object):
    ...
    def __init__(self, act_cpu=None, act_quantity=None, act_rate=None, after_completion=None, assignment_id=None, est_cpu=None, est_quantity=None, est_rate=None, material_units=None, resource_description=None, resource_id=None, start_date=None, units=None, _configuration=None):  # noqa: E501
