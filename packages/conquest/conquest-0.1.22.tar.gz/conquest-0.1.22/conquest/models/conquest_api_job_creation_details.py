...
class ConquestApiJobCreationDetails(object):
    ...
    def __init__(self, created=None, created_by=None, csv_import=None, device_id=None, empty=None, geopackage_import=None, geoupdate=None, issue_work_order=None, _configuration=None):  # noqa: E501
