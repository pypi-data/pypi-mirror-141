...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        self.label_contacts.setGeometry(QtCore.QRect(10, 0, 131, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_history.setGeometry(QtCore.QRect(300, 0, 141, 21))
        ...
        self.label_new_message.setGeometry(QtCore.QRect(300, 340, 171, 16))
