...
class UserApi:
    ...
    def change_plane_mode(self,flags=1):
        '''
        flag == 0 为B02模式, flag == 1 为B02s模式
        '''
        return self._control_server.change_plane_mode(flags)   

    def set_heightmode(self,model):
        '''
        model == 0:TOF定高模式
        model == 1:TOF+UWB混合定高模式
        model == 2:UWB定高模式
        '''     
        return self._control_server.set_heightmode(model)
    def change_station_num(self,num=4):
        '''
        num = 4, 6, 8
        '''
        return self._control_server.change_station_num(num)   

    def set_userheight(self,distance=300):
        '''
        distance: 300mm--2000mm
        '''

        return self._control_server.set_userheight(distance)  

    def change_language(self,message):
        '''
        language = Chg,Eng,TChn
        '''

        return self._control_server.change_language(message)           
...
#=============================================Station Config=====================================================================#
    ...
    def get_station_state(self):
        ...
        return self._control_server.get_station_state()
    ...
    def get_b02s_station_battery(self):

        return self._control_server.get_b02s_station_battery()
...
#================================================Plane State=====================================================================#
    ...
    def get_dance_json(self):

        return self._control_server.get_dance_json()
