...
DEFAULT_TIMEZONE = getattr(settings, "DEFAULT_TIMEZONE", pytz.timezone('utc'))
...
def from_iso8601(value=None, tz=DEFAULT_TIMEZONE, naive=False):
    _value = value
...
def to_date(value=None, tz=DEFAULT_TIMEZONE, none_to_now=True, naive=False):
    """
