...
from pyThorlabsPM100x.abstract_interface import abstract_interface
...
class interface(abstract_interface):
    ...
    def create_gui(self,parent,plot=False): 
        ...
        '''
        super().create_gui(parent)
        self.gui = gui(self,plot)
        self.gui.initialize()
        self.parent.setLayout(self.gui.container) 
...
class gui():
    def __init__(self,interface,plot=False):
