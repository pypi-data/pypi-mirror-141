...
def nestedModel(df, X_columns, y_column, model_regression = 'linear', metric = ['accuracy', 'nrmse', 'mape'], return_metric = False):
    metrics_values = {}
...
def mainNestedModel(sub_df, sub_X_columns, sub_y_column, X_columns, y_column, sub_model_regression = 'linear', sub_metric = ['accuracy', 'nrmse', 'mape'], return_sub_metric = False, model_regression = 'linear', metric = ['accuracy', 'nrmse', 'mape'], return_metric = False):
    metrics_values = {}
