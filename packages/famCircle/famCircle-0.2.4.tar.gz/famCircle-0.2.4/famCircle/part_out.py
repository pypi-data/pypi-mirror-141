...
class part_out():
    ...
    def ksrun(self):
        ...
        for i in family:# 去除不在染色体上的家族成员
            if i not in gff.keys():
                family.remove(i)
        return lens,chr_list,gff,blast,ks,family,family_dic
    ...
    def plot_arc_block(self, start, radius,col0):# block
        ...
        plot(x, y, col0, linewidth=3, alpha=0.5)
    ...
    def run(self):
        ...
        lens,chr_list,gff,blast,ks,family,family_dic = self.ksrun()
        # print(chr_list)
        ...
        for i in cluster:
            ...
            if self.parameter == 'True':
                ...
                label_x, label_y = self.rad_to_coord(start, self.radius_b*0.98)#1.2
                #print label_x, label_y
