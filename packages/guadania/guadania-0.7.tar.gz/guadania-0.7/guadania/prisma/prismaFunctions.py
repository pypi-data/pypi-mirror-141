...
def list_alerts_v2(prismaSession: PrismaSession,  timeType: str = 'relative', timeAmount: str = '30', timeUnit: TimeUnit = TimeUnit.DAY, detailed: bool = True,
                   sortBy: str = None, offset: int = 0, limit: int = 10000, pageToken: str = None, alertId: str = None, alertStatus: AlertStatus = None, 
                   cloudAccount: str = None, cloudAccountId: str = None, accountGroup: str = None, cloudType: CloudType = None, cloudRegion: str = None, 
                   cloudService: str = None, policyId: str = None, policyName: str = None, policySeverity: PolicySeverity = None, policyLabel: str = None, 
                   policyType: PolicyType = None, policyComplianceStandard: str = None, policyComplianceRequirement: str = None, policyComplianceSection: str = None, 
                   policyRemediable: bool = None, alertRuleName: str = None, resourceId: str = None, resourceName: str = None, resourceType: str = None) -> json:
    """
