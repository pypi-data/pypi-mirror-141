...
with open('C:/Files/Drive/GitHub/PyMono/pymono/version.py', 'r', encoding='utf-8') as f:  # Credits: LonamiWebs
...
setup(name='PyMonoLib',
      ...
      long_description=read('C:/Files/Drive/GitHub/PyMono/readme.md'),
