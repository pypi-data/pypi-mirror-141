...
def render_sql_template(sql, variables=None, test_mode=False, template_execution_results=None):
    ...
    'SELECT -170141183460469231731687303715884105728 as x, 170141183460469231731687303715884105727 as y'
    ...
    'SELECT -57896044618658097711785492504343953926634992332820282019728792003956564819968 as x, 57896044618658097711785492504343953926634992332820282019728792003956564819967 as y'
    """
