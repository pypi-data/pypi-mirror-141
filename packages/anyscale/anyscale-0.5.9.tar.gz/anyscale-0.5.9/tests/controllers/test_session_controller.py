...
def test_autopush(
    ...
    session_controller = SessionController()
    session_controller.api_client.get_session_head_ip_api_v2_sessions_session_id_head_ip_get.return_value.result.head_ip = (
        "127.0.0.1"
    )
    ...
    mock_managed_autosync_session.assert_called_once_with(
        session_test_data.id, session_controller.api_client
    )
