...
# @!! ...sys.cmds os::: cmdsSQL=SQL.databasesB:main
                ...
                # #########
                os.popen(f'cmd /k "python -c \"import importlib,os,sys;sys.path.append( \\\"{SS}\\\" );exec(f\\\"from {cc} import {ff};{ff}()\\\");  \""').read()
                os.system(f'cmd /k "python -c \"import importlib,os,sys;sys.path.append( \\\"{SS}\\\" );exec(f\\\"from {cc} import {ff};{ff}()\\\");  \""')
