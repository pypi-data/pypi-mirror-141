...
def ATOMIC_MASS():
    ...
    Return the constant atomic mass of a single Helium 3 atom.
    ...
    <ATOMIC_MASS>
        -- float --
    	The atomic mass of a single atom of Helium 3
        [Ø]
...
def MASS():
    ...
    return  Helium3.ATOMIC_MASS()/Constant.AVOGADRO()
...
def molar_entropy(temperature,pressure):
    ...
    if pressure == 0:
        ...
        if temperature <= 0.450 and temperature >= 0:
            ...
            print('Warning: The function Helium3.molat_entropy is not ' \
                  'defined for T = '+str(temperature)+' K')
            return np.nan
        ...
        print('Warning: The function Helium3.molar_entropy is not defined ' \
              'for P = '+str(pressure)+' Pa')
        return np.nan
...
def molar_volume(temperature,pressure):
    ...
    ################## If C1 True & C2 True ###################################
            ...
            print('Warning: The function Helium3.molar_volume is not '\
                  'defined for T = '+str(temperature)+' K')
        ...
        print('Warning: The function Helium3.molar_volume is not defined '\
              'for P = '+str(pressure)+' Pa')
...
def solid_liquid_transition(temperature):
    ...
    ################## If C1 False ############################################
        ...
        print('Warning: The function Helium3.solid_liquid_transition is ' \
              'not defined for T = '+str(temperature)+' K')
...
def liquid_thermal_conductivity(temperature,pressure):
    ...
    if pressure <= 20e6 and pressure >= 0:
        ...
        ################## If C1 True & C2 True ###############################
            ...
            print('Warning: The function Helium3.liquid_thermal_conductivity '\
        ...
        print('Warning: The function Helium3.liquid_thermal_conductivity is '\
              'not defined for P = '+str(pressure)+' Pa')
